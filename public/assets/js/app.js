...
function(g) {
    "use strict";
    function p(e, t) {
        return e = new Date(e.getFullYear(),e.getMonth(),e.getDate()).valueOf(),
        ((t = new Date(t.getFullYear(),t.getMonth(),t.getDate()).valueOf()) < e) - (e < t)
    }
    function s(e) {
    ...
    var e = function(e) {
        ...
        t.prototype = {
            ...
            weekStartDate: function(e) {
                for (var t = new Date(e.getTime()); t.getDay() !== this.firstWeekDay; )
            ...
            monthText: function(e, a) {
                ...
                return this.monthDates(e, a, function(e) {
                    for (var t = e.getMonth() === a ? e.getDate().toString() : "  "; t.length < 2; )
                        t = " " + t;
                    return t
                }, function(e) {
                    return e.join(" ")
        ...
        for (var a = "JAN FEB MAR APR MAY JUN JUL AUG SEP OCT NOV DEC".split(" "), n = 0; n < a.length; n++)
            t[a[n]] = n;
        return e.Calendar = t,
        e.Calendar
    }({})
    ...
    g.fn.calendar = function(c) {
        ...
        function r(e) {
            h.empty();
            for (var t, a, n = f.monthDates(e.getFullYear(), e.getMonth()), i = 0; i < n.length; i++)
                for (var o = n[i], r = 0; r < o.length; r++) {
                    ...
                    0 === p(s, y(s)) ? l.push("last-date-of-month") : 0 === p(s, m(s)) && l.push("first-date-of-month"),
                    c.selectedDay && 0 === p(s, c.selectedDay) && l.push("selected"),
                    (c.maxDate && 1 === p(s, c.maxDate) || c.minDate && -1 === p(s, c.minDate)) && l.push("disabled");
                    var d = g("<div/>", {
                        class: l.join(" ")
                    }).data("date", s).appendTo(h);
                    g("<div/>", {
                        class: "calendar-date-content"
                    }).appendTo(d).append(g.map(c.dayItemContents, function(e) {
        ...
        n.on("click", ".prev-month:not(.disabled), .next-month:not(.disabled)", function() {
            var e = g(this);
            u = e.hasClass("prev-month") ? new Date(u.getFullYear(),u.getMonth() - 1) : new Date(u.getFullYear(),u.getMonth() + 1),
            o(u),
            r(u)
        }),
        i.on("change", function() {
            var e = new Date(this.value);
            c.selectedDay = new Date(e.getFullYear(),e.getMonth(),e.getDate()),
            u = new Date(c.selectedDay.getFullYear(),c.selectedDay.getMonth()),
            o(u),
            r(u),
...
function(r) {
    ...
    function e(e) {
        var t = WPHJS.getContainerInnerWidth()
          ...
          , i = a < 576 ? 0 : (a - t) / 2;
        if (r(this).find(".card-slider-item:first").css("padding-left", i),
        ...
        t.on("ready.flickity change.flickity", function() {
            ...
            setTimeout(function() {
                var e = r(n).data("flickity")
                  ...
                  , a = "prevSlide" === o ? 0 : t;
                i.toggleClass("disabled", !e.options.wrapAround && e.selectedIndex === a),
                i.prop("disabled", !e.options.wrapAround && e.selectedIndex === a)
            }, 0)
        })
    }),
...
function(i) {
    ...
    o.each(function() {
        ...
        t.on("refresh", function(e) {
            e.stopPropagation(),
            t.prop("checked") ? a.addClass("checked") : a.removeClass("checked")
        }),
        ...
        n.on("click", function(e) {
            e.stopPropagation(),
            "radio" === t.attr("type") ? t.prop("checked", !0) : t.prop("checked", !t.prop("checked")),
            t.trigger("change")
        }),
        t.trigger("change")
    })
...
function(n) {
    ...
    n(".form-selectable-label[data-input]").each(function() {
        ...
        var t = n(this).attr("data-input")
          , a = n(t);
        a && (a.is('[type="radio"]') ? a.prop("checked", !0) : a.prop("checked", !a.prop("checked")),
        a.trigger("change"))
    });
    function t() {
        var e = n(this)
...
function(o) {
    ...
    e.find(".image-slider-prev, .image-slider-next").on("click", function(e) {
        ...
        "function" == typeof a.flickity && (e.preventDefault(),
    ...
    e.find(".image-slider-contents").on("ready.flickity change.flickity", function() {
        ...
        setTimeout(function() {
            var e = o(a).data("flickity")
              , t = e.slides.length ? e.slides.length - 1 : 0;
            n.toggleClass("disabled", 0 === e.selectedIndex).prop("disabled", 0 === e.selectedIndex),
            i.toggleClass("disabled", e.selectedIndex === t).prop("disabled", e.selectedIndex === t)
        }, 0)
    }),
...
function(i) {
    ...
    i(".radio-buttons-group:not(.radio-buttons-group-disabled)").each(function() {
        var a = i(this)
          , n = a.find(".btn");
        n.on("click", function(e) {
            e.preventDefault();
...
function(i) {
    ...
    i('[data-toggle="smooth-scroll"]').on("click", function(e) {
        ...
        if ("fixed" === o.css("position") && (r = o.outerHeight()),
        a) {
