function GoogleMaps_InfoBox_Factory(e) {
    ...
    return (t.prototype = new google.maps.OverlayView).createInfoBoxDiv_ = function() {
        ...
        if (!this.div_) {
            ...
            this.fixedWidthSet_ = !0) : (n = this.getBoxWidths_(),
            ...
            !this.enableEventPropagation_) {
                ...
                e = 0; e < i.length; e++)
                    this.eventListeners_.push(google.maps.event.addDomListener(this.div_, i[e], t));
    ...
    t.prototype.getCloseBoxImg_ = function() {
        var e = "";
        return "" !== this.closeBoxURL_ && (e = "<img",
    ...
    t.prototype.panBox_ = function(e) {
        ...
        if (!e && (t = this.getMap())instanceof google.maps.Map) {
            ...
            if (2 == t.panToBounds.length) {
                ...
                c.left = -o + l,
                c.right = o + s + l,
                this.alignBottom_ ? (c.top = -r + u + a,
                c.bottom = r + u) : (c.top = -r + u,
                c.bottom = r + a + u),
                t.panToBounds(new google.maps.LatLngBounds(this.position_), c)
            } else {
                var d = t.getDiv()
                  , f = d.offsetWidth
                  , h = d.offsetHeight
                  , p = this.getProjection().fromLatLngToContainerPixel(this.position_);
                if (p.x < -o + l ? i = p.x + o - l : p.x + s + o + l > f && (i = p.x + s + o + l - f),
                this.alignBottom_ ? p.y < -r + u + a ? n = p.y + r - u - a : p.y + r + u > h && (n = p.y + r + u - h) : p.y < -r + u ? n = p.y + r - u : p.y + a + r + u > h && (n = p.y + a + r + u - h),
                0 !== i || 0 !== n) {
                    t.getCenter();
                    t.panBy(i, n)
                }
    ...
    t.prototype.setBoxStyle_ = function() {
        ...
        if (this.div_) {
            ...
            void 0 !== this.div_.style.opacity && "" !== this.div_.style.opacity && (this.div_.style.MsFilter = '"progid:DXImageTransform.Microsoft.Alpha(Opacity=' + 100 * this.div_.style.opacity + ')"',
    ...
    t.prototype.getBoxWidths_ = function() {
        ...
        return document.defaultView && document.defaultView.getComputedStyle ? (e = i.ownerDocument.defaultView.getComputedStyle(i, "")) && (t.top = parseInt(e.borderTopWidth, 10) || 0,
        t.bottom = parseInt(e.borderBottomWidth, 10) || 0,
        t.left = parseInt(e.borderLeftWidth, 10) || 0,
        t.right = parseInt(e.borderRightWidth, 10) || 0) : document.documentElement.currentStyle && i.currentStyle && (t.top = parseInt(i.currentStyle.borderTopWidth, 10) || 0,
    ...
    t.prototype.getWidth = function() {
        var e = null;
        return this.div_ && (e = this.div_.offsetWidth),
        e
    }
    ,
    t.prototype.getHeight = function() {
        var e = null;
        return this.div_ && (e = this.div_.offsetHeight),
        e
    }
    ,
    ...
    t.prototype.open = function(e, t) {
        var i = this;
        t && (this.setPosition(t.getPosition()),
...
!function(r, d, f) {
    ...
    function p(e) {
        return "function" != typeof d.createElement ? d.createElement(e) : v ? d.createElementNS.call(d, "http://www.w3.org/2000/svg", e) : d.createElement.apply(d, arguments)
    }
    function o(e) {
    ...
    function s(e, t, i, n) {
        var o, r, s, a, l = "modernizr", u = p("div"), c = function() {
            var e = d.body;
            return e || ((e = p(v ? "svg" : "body")).fake = !0),
            e
        }();
        if (parseInt(i, 10))
            for (; i--; )
                (s = p("div")).id = n ? n[i] : l + (i + 1),
                u.appendChild(s);
        return (o = p("style")).type = "text/css",
        o.id = "s" + l,
        (c.fake ? c : u).appendChild(o),
        c.appendChild(u),
        ...
        g.style.overflow = a,
        g.offsetHeight) : u.parentNode.removeChild(u),
        !!r
    }
    function m(e, t) {
        var i = e.length;
    ...
    function n(e, t, i, n, o) {
        ...
        return h(t, "string") || h(t, "undefined") ? function(e, t, i, n) {
            function o() {
                s && (delete w.style,
                delete w.modElem)
            }
            if (n = !h(n, "undefined") && n,
            !h(i, "undefined")) {
                var r = m(e, i);
                if (!h(r, "undefined"))
                    return r
            }
            for (var s, a, l, u, c, d = ["modernizr", "tspan", "samp"]; !w.style && d.length; )
                s = !0,
                w.modElem = p(d.shift()),
            ...
            a = 0; a < l; a++)
                if (u = e[a],
                c = w.style[u],
                !~("" + u).indexOf("-") || (u = u.replace(/([a-z])-([a-z])/g, function(e, t, i) {
            ...
            for (var o in e)
                if (e[o]in t)
                    return !1 === i ? e[o] : h(n = t[e[o]], "function") ? a(n, i || t) : n;
            return !1
    ...
    t.testAllProps = n,
    t.testAllProps = e,
    c.addTest("cssmask", e("maskRepeat", "repeat-x", !0)),
    function() {
        var e, t, i, n, o, r;
        for (var s in u)
            if (u.hasOwnProperty(s)) {
                if (e = [],
                (t = u[s]).name && (e.push(t.name.toLowerCase()),
                t.options && t.options.aliases && t.options.aliases.length))
                    for (i = 0; i < t.options.aliases.length; i++)
                        e.push(t.options.aliases[i].toLowerCase());
                for (n = h(t.fn, "function") ? t.fn() : t.fn,
                o = 0; o < e.length; o++)
                    1 === (r = e[o].split(".")).length ? c[r[0]] = n : (!c[r[0]] || c[r[0]]instanceof Boolean || (c[r[0]] = new Boolean(c[r[0]])),
                    c[r[0]][r[1]] = n),
                    l.push((n ? "" : "no-") + r.join("-"))
            }
    }(),
    function(e) {
        ...
        c._config.enableClasses && (t += " " + i + e.join(" " + i),
...
function(e, t) {
    ...
    return function() {
        ...
        function s(e, t) {
            ...
            o();
            var l, u, c, d, f = !1, h = function() {
                e.resizedAttached && (f && (e.resizedAttached.call(),
                f = !1),
                g(h))
            };
            g(h);
            function p() {
                (c = e.offsetWidth) == l && (d = e.offsetHeight) == u || (f = !0,
                l = c,
                u = d),
                o()
            }
...
function(e, t) {
    ...
    T.extend = T.fn.extend = function() {
        ...
        a--); a < l; a++)
            if (null != (e = arguments[a]))
                for (t in e)
                    n = e[t],
                    "__proto__" !== t && s !== n && (u && n && (T.isPlainObject(n) || (o = Array.isArray(n))) ? (i = s[t],
                    r = o && !Array.isArray(i) ? [] : o || T.isPlainObject(i) ? i : {},
                    o = !1,
                    s[t] = T.extend(u, r, n)) : void 0 !== n && (s[t] = n));
        return s
    }
    ,
    T.extend({
        ...
        isPlainObject: function(e) {
            var t, i;
            return !(!e || "[object Object]" !== r.call(e)) && (!(t = n(e)) || "function" == typeof (i = v.call(t, "constructor") && t.constructor) && s.call(i) === u)
        },
        ...
        makeArray: function(e, t) {
            var i = t || [];
            return null != e && (d(Object(e)) ? T.merge(i, "string" == typeof e ? [e] : e) : l.call(i, e)),
            i
        },
    ...
    var f = function(i) {
        ...
        var e, h, _, r, s, p, f, m, w, l, u, x, E, a, S, g, c, v, y, T = "sizzle" + 1 * new Date, b = i.document, C = 0, n = 0, k = le(), A = le(), I = le(), D = le(), L = function(e, t) {
            return e === t && (u = !0),
            0
        }, N = {}.hasOwnProperty, t = [], P = t.pop, j = t.push, O = t.push, M = t.slice, z = function(e, t) {
            for (var i = 0, n = e.length; i < n; i++)
                if (e[i] === t)
                    return i;
            return -1
        }, B = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", H = "[\\x20\\t\\r\\n\\f]", q = "(?:\\\\[\\da-fA-F]{1,6}" + H + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", R = "\\[" + H + "*(" + q + ")(?:" + H + "*([*^$|!~]?=)" + H + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + q + "))|)" + H + "*\\]", F = ":(" + q + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + R + ")*)|.*)\\)|)", W = new RegExp(H + "+","g"), $ = new RegExp("^" + H + "+|((?:^|[^\\\\])(?:\\\\.)*)" + H + "+$","g"), V = new RegExp("^" + H + "*," + H + "*"), U = new RegExp("^" + H + "*([>+~]|" + H + ")" + H + "*"), Y = new RegExp(H + "|>"), Q = new RegExp(F), X = new RegExp("^" + q + "$"), G = {
            ID: new RegExp("^#(" + q + ")"),
            CLASS: new RegExp("^\\.(" + q + ")"),
            TAG: new RegExp("^(" + q + "|[*])"),
            ATTR: new RegExp("^" + R),
        ...
        function ae(t, e, i, n) {
            ...
            S)) {
                    ...
                    if (o = l[1]) {
                        if (9 === f) {
                            ...
                            if (s.id === o)
                                return i.push(s),
                                i
                        } else if (d && (s = d.getElementById(o)) && y(e, s) && s.id === o)
                            return i.push(s),
                            i
                    } else {
                        if (l[2])
                ...
                if (h.qsa && !D[t + " "] && (!g || !g.test(t)) && (1 !== f || "object" !== e.nodeName.toLowerCase())) {
                    if (c = t,
                    d = e,
                    1 === f && (Y.test(t) || U.test(t))) {
                        for ((d = ie.test(t) && ve(e.parentNode) || e) === e && h.scope || ((a = e.getAttribute("id")) ? a = a.replace(oe, re) : e.setAttribute("id", a = T)),
                        r = (u = p(t)).length; r--; )
                            u[r] = (a ? "#" + a : ":scope") + " " + be(u[r]);
                        c = u.join(",")
                    }
                    try {
                        return O.apply(i, d.querySelectorAll(c)),
                        i
                    } catch (e) {
                        D(t, !0)
                    } finally {
        ...
        x = ae.setDocument = function(e) {
            ...
            S = !s(E),
            b != E && (i = E.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", o, !1) : i.attachEvent && i.attachEvent("onunload", o)),
            ...
            (h.qsa = ee.test(E.querySelectorAll)) && (ce(function(e) {
                ...
                e.querySelectorAll("[selected]").length || g.push("\\[" + H + "*(?:value|" + B + ")"),
            ...
            L = t ? function(e, t) {
                ...
                return i || (1 & (i = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !h.sortDetached && t.compareDocumentPosition(e) === i ? e == E || e.ownerDocument == b && y(b, e) ? -1 : t == E || t.ownerDocument == b && y(b, t) ? 1 : l ? z(l, e) - z(l, t) : 0 : 4 & i ? -1 : 1)
            }
            : function(e, t) {
                if (e === t)
                    return u = !0,
                ...
                if (!o || !r)
                    return e == E ? -1 : t == E ? 1 : o ? -1 : r ? 1 : l ? z(l, e) - z(l, t) : 0;
                if (o === r)
                    return fe(e, t);
                ...
                for (; s[n] === a[n]; )
                    n++;
                return n ? fe(s[n], a[n]) : s[n] == b ? -1 : a[n] == b ? 1 : 0
            }
            ),
            E
        }
        ...
        ae.matchesSelector = function(e, t) {
            if (x(e),
            h.matchesSelector && S && !D[t + " "] && (!c || !c.test(t)) && (!g || !g.test(t)))
                try {
                    var i = v.call(e, t);
        ...
        ae.attr = function(e, t) {
            ...
            var i = _.attrHandle[t.toLowerCase()]
              , n = i && N.call(_.attrHandle, t.toLowerCase()) ? i(e, t, !S) : void 0;
        ...
        (_ = ae.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, i = !e[6] && e[2];
                    return G.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : i && Q.test(i) && (t = p(i, !0)) && (t = i.indexOf(")", i.length - t) - i.length) && (e[0] = e[0].slice(0, t),
                    e[2] = i.slice(0, t)),
                    e.slice(0, 3))
                }
            },
            filter: {
                ...
                CHILD: function(p, e, t, m, g) {
                    ...
                    : function(e, t, i) {
                        var n, o, r, s, a, l, u = v != y ? "nextSibling" : "previousSibling", c = e.parentNode, d = b && e.nodeName.toLowerCase(), f = !i && !b, h = !1;
                        if (c) {
                            if (v) {
                                for (; u; ) {
                                    for (s = e; s = s[u]; )
                            ...
                            y && f) {
                                for (h = (a = (n = (o = (r = (s = c)[T] || (s[T] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] || [])[0] === C && n[1]) && n[2],
                                s = a && c.childNodes[a]; s = ++a && s && s[u] || (h = a = 0) || l.pop(); )
                                    if (1 === s.nodeType && ++h && s === e) {
                                        o[p] = [C, a, h];
                                        break
                                    }
                            } else if (f && (h = a = (n = (o = (r = (s = e)[T] || (s[T] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] || [])[0] === C && n[1]),
                            !1 === h)
                                for (; (s = ++a && s && s[u] || (h = a = 0) || l.pop()) && ((b ? s.nodeName.toLowerCase() !== d : 1 !== s.nodeType) || !++h || (f && ((o = (r = s[T] || (s[T] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] = [C, h]),
                                s !== e)); )
                                    ;
            ...
            pseudos: {
                ...
                lang: ue(function(i) {
                    return X.test(i || "") || ae.error("unsupported lang: " + i),
            ...
            ue(function(e, t, i, n) {
                var o, r, s, a = [], l = [], u = t.length, c = e || function(e, t, i) {
                    for (var n = 0, o = t.length; n < o; n++)
                        ae(e, t[n], i);
                    return i
                }(p || "*", i.nodeType ? [i] : i, []), d = !h || !e && p ? c : xe(c, a, h, i, n), f = m ? v || (e ? h : u || g) ? [] : t : d;
                if (m && m(d, f, i, n),
                g)
                    for (o = xe(f, l),
                    g(o, [], i, n),
                ...
                if (e) {
                    if (v || h) {
                        ...
                        for (r = f.length; r--; )
                            (s = f[r]) && -1 < (o = v ? z(e, s) : a[r]) && (e[o] = !(t[o] = s))
                    }
                } else
                    f = xe(f === t ? f.splice(u, f.length) : f),
                    v ? v(null, t, f, n) : O.apply(t, f)
            })
        }
        function Se(e) {
            for (var o, t, i, n = e.length, r = _.relative[e[0].type], s = r || _.relative[" "], a = r ? 1 : 0, l = _e(function(e) {
                ...
                var n = !r && (i || t !== w) || ((o = t).nodeType ? l(e, t, i) : u(e, t, i));
                return o = null,
                n
            }
            ]; a < n; a++)
                if (t = _.relative[e[a].type])
                    ...
                    if ((t = _.filter[e[a].type].apply(null, e[a].matches))[T]) {
                        for (i = ++a; i < n && !_.relative[e[i].type]; i++)
                            ;
                        return Ee(1 < a && we(c), 1 < a && be(e.slice(0, a - 1).concat({
                            value: " " === e[a - 2].type ? "*" : ""
        ...
        p = ae.tokenize = function(e, t) {
            var i, n, o, r, s, a, l, u = A[e + " "];
            if (u)
                return t ? 0 : u.slice(0);
            for (s = e,
            a = [],
            l = _.preFilter; s; ) {
                for (r in i && !(n = V.exec(s)) || (n && (s = s.slice(n[0].length) || s),
                a.push(o = [])),
                i = !1,
                (n = U.exec(s)) && (i = n.shift(),
                o.push({
                    value: i,
                    type: n[0].replace($, " ")
                }),
        ...
        f = ae.compile = function(e, t) {
            ...
            if (!r) {
                for (i = (t = t || p(e)).length; i--; )
                    (r = Se(t[i]))[T] ? n.push(r) : o.push(r);
                (r = I(e, function(g, v) {
                    function e(e, t, i, n, o) {
                        var r, s, a, l = 0, u = "0", c = e && [], d = [], f = w, h = e || b && _.find.TAG("*", o), p = C += null == f ? 1 : Math.random() || .1, m = h.length;
                        for (o && (w = t == E || t || o); u !== m && null != (r = h[u]); u++) {
                            if (b && r) {
                                for (s = 0,
                                t || r.ownerDocument == E || (x(r),
                                i = !S); a = g[s++]; )
                                    if (a(r, t || E, i)) {
                                        n.push(r);
                                        break
        ...
        m = ae.select = function(e, t, i, n) {
            var o, r, s, a, l, u = "function" == typeof e && e, c = !n && p(e = u.selector || e);
            if (i = i || [],
            1 === c.length) {
                if (2 < (r = c[0] = c[0].slice(0)).length && "ID" === (s = r[0]).type && 9 === t.nodeType && S && _.relative[r[1].type]) {
                    if (!(t = (_.find.ID(s.matches[0].replace(ne, d), t) || [])[0]))
                        return i;
                    u && (t = t.parentNode),
                    e = e.slice(r.shift().value.length)
                }
                for (o = G.needsContext.test(e) ? 0 : r.length; o-- && (s = r[o],
                !_.relative[a = s.type]); )
                    if ((l = _.find[a]) && (n = l(s.matches[0].replace(ne, d), ie.test(r[0].type) && ve(t.parentNode) || t))) {
                        if (r.splice(o, 1),
                        !(e = n.length && be(r)))
                            return O.apply(i, n),
                            i;
            ...
            return (u || f(e, c))(n, t, !S, i, !t || ie.test(e) && ve(t.parentNode) || t),
            i
        }
        ,
        h.sortStable = T.split("").sort(L).join("") === T,
    ...
    (T.fn.init = function(e, t, i) {
        ...
        if (n[1]) {
            ...
            T.merge(this, T.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : S, !0)),
            k.test(n[1]) && T.isPlainObject(t))
                for (n in t)
                    b(this[n]) ? this[n](t[n]) : this.attr(n, t[n]);
            return this
        }
        return (o = S.getElementById(n[2])) && (this[0] = o,
        this.length = 1),
        this
    }
    ).prototype = T.fn,
    ...
    T.each({
        ...
        T.fn[n] = function(e, t) {
            ...
            1 < this.length && (N[n] || T.uniqueSort(i),
            L.test(n) && i.reverse()),
            this.pushStack(i)
        }
    });
    ...
    T.Callbacks = function(n) {
        n = "string" == typeof n ? function(e) {
            var i = {};
            return T.each(e.match(j) || [], function(e, t) {
                i[t] = !0
            }),
            i
        }(n) : T.extend({}, n);
        function i() {
            ...
            t = o = !0; a.length; l = -1)
                for (e = a.shift(); ++l < s.length; )
                    !1 === s[l].apply(e[0], e[1]) && n.stopOnFalse && (l = s.length,
                    e = !1);
            n.memory || (e = !1),
            o = !1,
            r && (s = e ? [] : "")
        }
        var o, e, t, r, s = [], a = [], l = -1, u = {
            add: function() {
                return s && (e && !o && (l = s.length - 1,
                a.push(e)),
                function i(e) {
                    T.each(e, function(e, t) {
                        b(t) ? n.unique && u.has(t) || s.push(t) : t && t.length && "string" !== w(t) && i(t)
                    })
                }(arguments),
                e && !o && i()),
                this
    ...
    T.extend({
              ...
              , s = {
                ...
                then: function(t, i, n) {
                        ...
                        return function() {
                            function e() {
                                ...
                                if (!(o < l)) {
                                    ...
                                    b(t) ? a ? t.call(e, u(l, r, O, a), u(l, r, M, a)) : (l++,
                                    t.call(e, u(l, r, O, a), u(l, r, M, a), u(l, r, O, r.notifyWith))) : (s !== O && (i = void 0,
                                    n = [e]),
                                    (a || r.resolveWith)(i, n))
                                }
                            }
                    ...
                    return T.Deferred(function(e) {
                        r[0][3].add(u(0, e, b(n) ? n : O, e.notifyWith)),
                        r[1][3].add(u(0, e, b(t) ? t : O)),
                        r[2][3].add(u(0, e, b(i) ? i : M))
                    }).promise()
                },
                promise: function(e) {
        ...
        when: function(e) {
            ...
            var i = arguments.length
              ...
              , r = a.call(arguments)
              , s = T.Deferred();
            if (i <= 1 && (z(e, s.done(t(n)).resolve, s.reject, !i),
    ...
    T.ready.then = H.then,
    "complete" === S.readyState || "loading" !== S.readyState && !S.documentElement.doScroll ? E.setTimeout(T.ready) : (S.addEventListener("DOMContentLoaded", q),
        ...
        data: function(i, e) {
            ...
            if (void 0 !== i)
                return "object" == typeof i ? this.each(function() {
                    ...
                    var t;
                    if (r && void 0 === e)
                        return void 0 !== (t = X.get(r, i)) ? t : void 0 !== (t = J(r, i)) ? t : void 0;
                    this.each(function() {
                        X.set(this, i, e)
                    })
    ...
    T.extend({
        queue: function(e, t, i) {
            ...
            if (e)
                return t = (t || "fx") + "queue",
                n = Q.get(e, t),
                i && (!n || Array.isArray(i) ? n = Q.access(e, t, T.makeArray(i)) : n.push(i)),
                n || []
        },
    ...
    T.fn.extend({
        ...
        promise: function(e, t) {
            ...
            e = void 0),
            e = e || "fx"; a--; )
                (n = Q.get(s[a], e + "queueHooks")) && n.empty && (o++,
                n.empty.add(i));
            return i(),
            r.promise(t)
        }
    ...
    function se(e, t, i, n) {
        ...
        , l = a(), u = i && i[3] || (T.cssNumber[t] ? "" : "px"), c = e.nodeType && (T.cssNumber[t] || "px" !== u && +l) && ee.exec(T.css(e, t));
        if (c && c[3] !== u) {
            for (l /= 2,
            u = u || c[3],
            c = +l || 1; s--; )
    ...
    var ae = {};
    function le(e, t) {
        for (var i, n, o, r, s, a, l, u = [], c = 0, d = e.length; c < d; c++)
            (n = e[c]).style && (i = n.style.display,
            t ? ("none" === i && (u[c] = Q.get(n, "display") || null,
            u[c] || (n.style.display = "")),
            "" === n.style.display && re(n) && (u[c] = (l = s = r = void 0,
            s = (o = n).ownerDocument,
            a = o.nodeName,
    ...
    var ue, ce, de = /^(?:checkbox|radio)$/i, fe = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i, he = /^$|^module$|\/(?:java|ecma)script/i;
    ...
    function me(e, t) {
        ...
        void 0 === t || t && C(e, t) ? T.merge([e], i) : i
    }
    function ge(e, t) {
        for (var i = 0, n = e.length; i < n; i++)
    ...
    function Ce(e, o, r) {
        ...
        })) : void 0 === Q.get(e, o) && T.event.add(e, o, xe)
    }
    T.event = {
        global: {},
        add: function(t, e, i, n, o) {
            var r, s, a, l, u, c, d, f, h, p, m, g = Q.get(t);
            if (U(t))
                ...
                u = (e = (e || "").match(j) || [""]).length; u--; )
                    ...
                    d.setup && !1 !== d.setup.call(t, n, p, s) || t.addEventListener && t.addEventListener(h, s)),
        ...
        remove: function(e, t, i, n, o) {
            var r, s, a, l, u, c, d, f, h, p, m, g = Q.hasData(e) && Q.get(e);
            if (g && (l = g.events)) {
                for (u = (t = (t || "").match(j) || [""]).length; u--; )
                    if (h = m = (a = we.exec(t[u]) || [])[1],
                    p = (a[2] || "").split(".").sort(),
                    h) {
                        for (d = T.event.special[h] || {},
                        f = l[h = (n ? d.delegateType : d.bindType) || h] || [],
                        a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"),
                        s = r = f.length; r--; )
                            c = f[r],
                            !o && m !== c.origType || i && i.guid !== c.guid || a && !a.test(c.namespace) || n && n !== c.selector && ("**" !== n || !c.selector) || (f.splice(r, 1),
                            c.selector && f.delegateCount--,
                            d.remove && d.remove.call(e, c));
                        s && !f.length && (d.teardown && !1 !== d.teardown.call(e, p, g.handle) || T.removeEvent(e, h, g.handle),
                        delete l[h])
                    } else
                        for (h in l)
                            T.event.remove(e, h + t[u], i, n, !0);
                T.isEmptyObject(l) && Q.remove(e, "handle events")
            }
        },
        dispatch: function(e) {
            var t, i, n, o, r, s, a = new Array(arguments.length), l = T.event.fix(e), u = (Q.get(this, "events") || Object.create(null))[l.type] || [], c = T.event.special[l.type] || {};
            for (a[0] = l,
            ...
            !c.preDispatch || !1 !== c.preDispatch.call(this, l)) {
                ...
                t = 0; (o = s[t++]) && !l.isPropagationStopped(); )
                    ...
                    i = 0; (r = o.handlers[i++]) && !l.isImmediatePropagationStopped(); )
                        ...
                        l.data = r.data,
                        void 0 !== (n = ((T.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, a)) && !1 === (l.result = n) && (l.preventDefault(),
                        l.stopPropagation()));
            ...
            if (l && u.nodeType && !("click" === e.type && 1 <= e.button))
                for (; u !== this; u = u.parentNode || this)
                    if (1 === u.nodeType && ("click" !== e.type || !0 !== u.disabled)) {
                        ...
                        s = {},
                        i = 0; i < l; i++)
                            void 0 === s[o = (n = t[i]).selector + " "] && (s[o] = n.needsContext ? -1 < T(o, this).index(u) : T.find(o, this, null, [u]).length),
                            s[o] && r.push(n);
                        r.length && a.push({
                            elem: u,
                            handlers: r
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return de.test(t.type) && t.click && C(t, "input") && Ce(t, "click", xe),
                    !1
                },
                trigger: function(e) {
                    var t = this || e;
                    return de.test(t.type) && t.click && C(t, "input") && Ce(t, "click"),
                    !0
                },
                _default: function(e) {
                    var t = e.target;
                    return de.test(t.type) && t.click && C(t, "input") && Q.get(t, "click") || C(t, "a")
                }
            },
            beforeunload: {
    ...
    function je(i, n, o, r) {
        n = g(n);
        var e, t, s, a, l, u, c = 0, d = i.length, f = d - 1, h = n[0], p = b(h);
        if (p || 1 < d && "string" == typeof h && !y.checkClone && Ae.test(h))
            return i.each(function(e) {
                var t = i.eq(e);
                p && (n[0] = h.call(this, e, t.html())),
                je(t, n, o, r)
            });
        if (d && (t = (e = ye(n, i[0].ownerDocument, !1, i, r)).firstChild,
        1 === e.childNodes.length && (e = t),
        t || r)) {
            for (a = (s = T.map(me(e, "script"), Le)).length; c < d; c++)
                l = e,
                c !== f && (l = T.clone(l, !0, !0),
            ...
            if (a)
                ...
                c = 0; c < a; c++)
                    l = s[c],
                    he.test(l.type || "") && !Q.access(l, "globalEval") && T.contains(u, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? T._evalUrl && !l.noModule && T._evalUrl(l.src, {
    ...
    function Oe(e, t, i) {
        for (var n, o = t ? T.filter(t, e) : e, r = 0; null != (n = o[r]); r++)
            i || 1 !== n.nodeType || T.cleanData(me(n)),
            n.parentNode && (i && ne(n) && ge(me(n, "script")),
    ...
    T.extend({
        ...
        clone: function(e, t, i) {
            var n, o, r, s, a, l, u, c = e.cloneNode(!0), d = ne(e);
            ...
            if (t)
                if (i)
                    ...
                    Pe(e, c);
            return 0 < (s = me(c, "script")).length && ge(s, !d && me(e, "script")),
            c
        },
    ...
    T.fn.extend({
        ...
        html: function(e) {
            return R(this, function(e) {
                ...
                if ("string" == typeof e && !ke.test(e) && !pe[(fe.exec(e) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; i < n; i++)
                            1 === (t = this[i] || {}).nodeType && (T.cleanData(me(t, !1)),
                            t.innerHTML = e);
                        t = 0
                    } catch (e) {}
                }
        ...
        replaceWith: function() {
            ...
            return je(this, arguments, function(e) {
                ...
                T.inArray(this, i) < 0 && (T.cleanData(me(this)),
    ...
    var ze, Be, He, qe, Re, Fe, We, $e, Ve = new RegExp("^(" + Z + ")(?!px)[a-z%]+$","i"), Ue = function(e) {
    ...
    function Ge(e, t, i) {
        ...
        return (i = i || Ue(e)) && ("" !== (s = i.getPropertyValue(t) || i[t]) || ne(e) || (s = T.style(e, t)),
        !y.pixelBoxStyles() && Ve.test(s) && Ye.test(t) && (n = a.width,
        o = a.minWidth,
        r = a.maxWidth,
    ...
    T.extend(y, {
        ...
        reliableTrDimensions: function() {
            ...
            t.style.height = "1px",
            i.style.height = "9px",
            ie.appendChild(e).appendChild(t).appendChild(i),
    ...
    function at(e, t, i, n, o, r) {
        ...
        if (i === (n ? "border" : "content"))
            return 0;
        for (; s < 4; s += 2)
            "margin" === i && (l += T.css(e, i + te[s], !0, o)),
            n ? ("content" === i && (l -= T.css(e, "padding" + te[s], !0, o)),
            "margin" !== i && (l -= T.css(e, "border" + te[s] + "Width", !0, o))) : (l += T.css(e, "padding" + te[s], !0, o),
            "padding" !== i ? l += T.css(e, "border" + te[s] + "Width", !0, o) : a += T.css(e, "border" + te[s] + "Width", !0, o));
    ...
    function lt(e, t, i) {
        ...
        return (!y.boxSizingReliable() && o || !y.reliableTrDimensions() && C(e, "tr") || "auto" === s || !parseFloat(s) && "inline" === T.css(e, "display", !1, n)) && e.getClientRects().length && (o = "border-box" === T.css(e, "boxSizing", !1, n),
        (r = a in e) && (s = e[a])),
        (s = parseFloat(s) || 0) + at(e, t, i || (o ? "border" : "content"), r, n, s) + "px"
    }
    ...
    T.extend({
        ...
        style: function(e, t, i, n) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, r, s, a = V(t), l = nt.test(t), u = e.style;
                if (l || (t = tt(a)),
                s = T.cssHooks[t] || T.cssHooks[a],
                void 0 === i)
                    return s && "get"in s && void 0 !== (o = s.get(e, !1, n)) ? o : u[t];
                "string" === (r = typeof i) && (o = ee.exec(i)) && o[1] && (i = se(e, t, o),
                r = "number"),
                null != i && i == i && ("number" !== r || l || (i += o && o[3] || (T.cssNumber[a] ? "" : "px")),
                y.clearCloneStyle || "" !== i || 0 !== t.indexOf("background") || (u[t] = "inherit"),
                s && "set"in s && void 0 === (i = s.set(e, i, n)) || (l ? u.setProperty(t, i) : u[t] = i))
            }
        },
        css: function(e, t, i, n) {
            var o, r, s, a = V(t);
            return nt.test(t) || (t = tt(a)),
    ...
    T.each(["height", "width"], function(e, l) {
        T.cssHooks[l] = {
            get: function(e, t, i) {
                if (t)
                    return !it.test(T.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? lt(e, l, i) : Me(e, ot, function() {
                        return lt(e, l, i)
                    })
            },
            set: function(e, t, i) {
                var n, o = Ue(e), r = !y.scrollboxSize() && "absolute" === o.position, s = (r || i) && "border-box" === T.css(e, "boxSizing", !1, o), a = i ? at(e, l, i, s, o) : 0;
                return s && r && (a -= Math.ceil(e["offset" + l[0].toUpperCase() + l.slice(1)] - parseFloat(o[l]) - at(e, l, "border", !1, o) - .5)),
                a && (n = ee.exec(t)) && "px" !== (n[3] || "px") && (e.style[l] = t,
                t = T.css(e, l)),
                st(0, t, a)
            }
        }
    ...
    T.cssHooks.marginLeft = Ke(y.reliableMarginLeft, function(e, t) {
        if (t)
            return (parseFloat(Ge(e, "marginLeft")) || e.getBoundingClientRect().left - Me(e, {
                marginLeft: 0
            }, function() {
        ...
        T.cssHooks[o + r] = {
            expand: function(e) {
                for (var t = 0, i = {}, n = "string" == typeof e ? e.split(" ") : [e]; t < 4; t++)
                    i[o + te[t] + r] = n[t] || n[t - 2] || n[0];
                return i
            }
        },
        "margin" !== o && (T.cssHooks[o + r].set = st)
    }),
    T.fn.extend({
        css: function(e, t) {
    ...
    T.fx.step = {};
    var ct, dt, ft, ht, pt = /^(?:toggle|show|hide)$/, mt = /queueHooks$/;
    function gt() {
        dt && (!1 === S.hidden && E.requestAnimationFrame ? E.requestAnimationFrame(gt) : E.setTimeout(gt, T.fx.interval),
        T.fx.tick())
    }
    function vt() {
    ...
    function yt(e, t) {
        ...
        for (t = t ? 1 : 0; n < 4; n += 2 - t)
            o["margin" + (i = te[n])] = o["padding" + i] = e;
        return t && (o.opacity = o.width = e),
        o
    }
    function bt(e, t, i) {
        for (var n, o = (_t.tweeners[t] || []).concat(_t.tweeners["*"]), r = 0, s = o.length; r < s; r++)
            if (n = o[r].call(i, t, e))
                return n
    }
    function _t(r, e, t) {
        var i, s, n = 0, o = _t.prefilters.length, a = T.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (s)
                return !1;
            for (var e = ct || vt(), t = Math.max(0, u.startTime + u.duration - e), i = 1 - (t / u.duration || 0), n = 0, o = u.tweens.length; n < o; n++)
                u.tweens[n].run(i);
            return a.notifyWith(r, [u, i, t]),
            i < 1 && o ? t : (o || a.notifyWith(r, [u, 1, 0]),
            a.resolveWith(r, [u]),
            !1)
        }, u = a.promise({
            elem: r,
            ...
            createTween: function(e, t) {
                var i = T.Tween(r, u.opts, e, t, u.opts.specialEasing[e] || u.opts.easing);
            ...
            stop: function(e) {
                ...
                for (s = !0; t < i; t++)
                    u.tweens[t].run(1);
                return e ? (a.notifyWith(r, [u, 1, 0]),
                a.resolveWith(r, [u, e])) : a.rejectWith(r, [u, e]),
                this
            }
        }), c = u.props;
        for (!function(e, t) {
            ...
            if (i = _t.prefilters[n].call(u, r, c, u.opts))
                return b(i.stop) && (T._queueHooks(u.elem, u.opts.queue).stop = i.stop.bind(i)),
                i;
        return T.map(c, bt, u),
        b(u.opts.start) && u.opts.start.call(r, u),
    ...
    T.Animation = T.extend(_t, {
        tweeners: {
            "*": [function(e, t) {
                ...
                return se(i.elem, e, ee.exec(t), i),
                i
            }
            ]
        },
        tweener: function(e, t) {
            ...
            ["*"]) : e.match(j)).length; n < o; n++)
                i = e[n],
                _t.tweeners[i] = _t.tweeners[i] || [],
                _t.tweeners[i].unshift(t)
        },
        prefilters: [function(e, t, i) {
            var n, o, r, s, a, l, u, c, d = "width"in t || "height"in t, f = this, h = {}, p = e.style, m = e.nodeType && re(e), g = Q.get(e, "fxshow");
            ...
            if ((l = !T.isEmptyObject(t)) || !T.isEmptyObject(h))
                ...
                c = T.css(e, "display"),
                le([e]))),
                ("inline" === c || "inline-block" === c && null != u) && "none" === T.css(e, "float") && (l || (f.done(function() {
                    p.display = u
                }),
                null == u && (c = p.display,
                u = "none" === c ? "" : c)),
    ...
    T.fn.extend({
        ...
        finish: function(s) {
            return !1 !== s && (s = s || "fx"),
            this.each(function() {
                var e, t = Q.get(this), i = t[s + "queue"], n = t[s + "queueHooks"], o = T.timers, r = i ? i.length : 0;
                for (t.finish = !0,
                T.queue(this, s, []),
    ...
    T.extend({
        attr: function(e, t, i) {
            ...
            if (3 !== r && 8 !== r && 2 !== r)
                return void 0 === e.getAttribute ? T.prop(e, t, i) : (1 === r && T.isXMLDoc(e) || (o = T.attrHooks[t.toLowerCase()] || (T.expr.match.bool.test(t) ? wt : void 0)),
    ...
    T.fn.extend({
        ...
        toggleClass: function(o, t) {
            ...
            return "boolean" == typeof t && s ? t ? this.addClass(o) : this.removeClass(o) : b(o) ? this.each(function(e) {
                ...
                if (s)
                    ...
                    void 0 !== o && "boolean" != r || ((e = Ct(this)) && Q.set(this, "__className__", e),
        ...
        hasClass: function(e) {
            var t, i, n = 0;
            for (t = " " + e + " "; i = this[n++]; )
                if (1 === i.nodeType && -1 < (" " + Tt(Ct(i)) + " ").indexOf(t))
                    return !0;
            return !1
        }
    });
    ...
    T.fn.extend({
        val: function(i) {
            ...
            })) : t ? (n = T.valHooks[t.type] || T.valHooks[t.nodeName.toLowerCase()]) && "get"in n && void 0 !== (e = n.get(t, "value")) ? e : "string" == typeof (e = t.value) ? e.replace(At, "") : null == e ? "" : e : void 0
        }
    }),
    T.extend({
        valHooks: {
    ...
    T.extend(T.event, {
        trigger: function(e, t, i, n) {
            var o, r, s, a, l, u, c, d, f = [i || S], h = v.call(e, "type") ? e.type : e, p = v.call(e, "namespace") ? e.namespace.split(".") : [];
            if (r = d = s = i = i || S,
            3 !== i.nodeType && 8 !== i.nodeType && !Dt.test(h + T.event.triggered) && (-1 < h.indexOf(".") && (h = (p = h.split(".")).shift(),
            p.sort()),
            l = h.indexOf(":") < 0 && "on" + h,
            ...
            n || !c.trigger || !1 !== c.trigger.apply(i, t))) {
                if (!n && !c.noBubble && !m(i)) {
                    ...
                    Dt.test(a + h) || (r = r.parentNode); r; r = r.parentNode)
                        f.push(r),
                        s = r;
                    s === (i.ownerDocument || S) && f.push(s.defaultView || s.parentWindow || E)
                }
                for (o = 0; (r = f[o++]) && !e.isPropagationStopped(); )
                    d = r,
                    e.type = 1 < o ? a : c.bindType || h,
                    (u = (Q.get(r, "events") || Object.create(null))[e.type] && Q.get(r, "handle")) && u.apply(r, t),
                    (u = l && r[l]) && u.apply && U(r) && (e.result = u.apply(r, t),
                    !1 === e.result && e.preventDefault());
                return e.type = h,
                n || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(f.pop(), t) || !U(i) || l && b(i[h]) && !m(i) && ((s = i[l]) && (i[l] = null),
                T.event.triggered = h,
    ...
    function Bt(i, e, n, o) {
        ...
        if (Array.isArray(e))
            T.each(e, function(e, t) {
                n || jt.test(i) ? o(i, t) : Bt(i + "[" + ("object" == typeof t && null != t ? e : "") + "]", t, n, o)
            });
    ...
    T.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !T(this).is(":disabled") && zt.test(this.nodeName) && !Mt.test(e) && (this.checked || !de.test(e))
            }).map(function(e, t) {
                var i = T(this).val();
    ...
    function Xt(r) {
        return function(e, t) {
            "string" != typeof e && (t = e,
            e = "*");
            var i, n = 0, o = e.toLowerCase().match(j) || [];
            if (b(t))
                for (; i = o[n++]; )
                    "+" === i[0] ? (i = i.slice(1) || "*",
    ...
    T.extend({
        ...
        ajax: function(e, t) {
            ...
            e = void 0),
            t = t || {};
            var c, d, f, i, h, n, p, m, o, r, g = T.ajaxSetup({}, t), v = g.context || g, y = g.context && (v.nodeType || v.jquery) ? T(v) : T.event, b = T.Deferred(), _ = T.Callbacks("once memory"), w = g.statusCode || {}, s = {}, a = {}, l = "canceled", x = {
                readyState: 0,
            ...
            if (b.promise(x),
            g.url = ((e || g.url || Lt.href) + "").replace($t, Lt.protocol + "//"),
            ...
            null == g.crossDomain) {
                ...
                try {
                    n.href = g.url,
                    n.href = n.href,
                    g.crossDomain = Qt.protocol + "//" + Qt.host != n.protocol + "//" + n.host
                } catch (e) {
                    g.crossDomain = !0
                }
            }
            ...
            d = g.url.replace(qt, ""),
            g.hasContent ? g.data && g.processData && 0 === (g.contentType || "").indexOf("application/x-www-form-urlencoded") && (g.data = g.data.replace(Ht, "+")) : (r = g.url.slice(d.length),
            ...
            x.setRequestHeader("Accept", g.dataTypes[0] && g.accepts[g.dataTypes[0]] ? g.accepts[g.dataTypes[0]] + ("*" !== g.dataTypes[0] ? ", " + Yt + "; q=0.01" : "") : g.accepts["*"]),
            g.headers)
            ...
            function u(e, t, i, n) {
                ...
                !o && -1 < T.inArray("script", g.dataTypes) && (g.converters["text script"] = function() {}
                ),
                a = function(e, t, i, n) {
                ...
                o ? (g.ifModified && ((l = x.getResponseHeader("Last-Modified")) && (T.lastModified[d] = l),
                ...
                x.statusCode(w),
                w = void 0,
                m && y.trigger(o ? "ajaxSuccess" : "ajaxError", [x, g, o ? r : s]),
                _.fireWith(v, [x, u]),
                ...
                send: function(e, t) {
                    ...
                    r = function(e) {
                        return function() {
                            ...
                            "abort" === e ? n.abort() : "error" === e ? "number" != typeof n.status ? t(0, "error") : t(n.status, n.statusText) : t(Jt[n.status] || n.status, n.statusText, "text" !== (n.responseType || "text") || "string" != typeof n.responseText ? {
                                binary: n.response
                            } : {
                                text: n.responseText
    ...
    T.ajaxSetup({
        ...
        jsonpCallback: function() {
            var e = ti.pop() || T.expando + "_" + Nt.guid++;
            return this[e] = !0,
            e
        }
    }),
    T.ajaxPrefilter("json jsonp", function(e, t, i) {
        var n, o, r, s = !1 !== e.jsonp && (ii.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && ii.test(e.data) && "data");
        if (s || "jsonp" === e.dataTypes[0])
            return n = e.jsonpCallback = b(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback,
            s ? e[s] = e[s].replace(ii, "$1" + n) : !1 !== e.jsonp && (e.url += (Pt.test(e.url) ? "&" : "?") + e.jsonp + "=" + n),
            ...
            ,
            i.always(function() {
                void 0 === o ? T(E).removeProp(n) : E[n] = o,
    ...
    y.createHTMLDocument = ((ei = S.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    2 === ei.childNodes.length),
    T.parseHTML = function(e, t, i) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (i = t,
        t = !1),
        t || (y.createHTMLDocument ? ((n = (t = S.implementation.createHTMLDocument("")).createElement("base")).href = S.location.href,
        t.head.appendChild(n)) : t = S),
        r = !i && [],
        (o = k.exec(e)) ? [t.createElement(o[1])] : (o = ye([e], t, r),
    ...
    T.offset = {
        setOffset: function(e, t, i) {
            var n, o, r, s, a, l, u = T.css(e, "position"), c = T(e), d = {};
    ...
    T.each(["top", "left"], function(e, i) {
        T.cssHooks[i] = Ke(y.pixelPosition, function(e, t) {
            if (t)
                return t = Ge(e, i),
                Ve.test(t) ? T(e).position()[i] + "px" : t
        })
    }),
    T.each({
        Height: "height",
        ...
        T.each({
            ...
            T.fn[r] = function(e, t) {
                ...
                return R(this, function(e, t, i) {
                    var n;
                    return m(e) ? 0 === r.indexOf("outer") ? e["inner" + s] : e.document.documentElement["client" + s] : 9 === e.nodeType ? (n = e.documentElement,
    ...
    return T.noConflict = function(e) {
        return E.$ === T && (E.$ = ri),
        e && E.jQuery === T && (E.jQuery = oi),
        T
    }
    ,
    void 0 === e && (E.jQuery = E.$ = T),
    T
}),
function(e, t) {
    ...
    var p = {
        ...
        getTransitionDurationFromElement: function(e) {
            ...
            var t = h.default(e).css("transition-duration")
              , i = h.default(e).css("transition-delay")
              , n = parseFloat(t)
              , o = parseFloat(i);
        ...
        typeCheckConfig: function(e, t, i) {
            for (var n in i)
                if (Object.prototype.hasOwnProperty.call(i, n)) {
                    var o = i[n]
                      , r = t[n]
                      , s = r && p.isElement(r) ? "element" : null == (a = r) ? "" + a : {}.toString.call(a).match(/\s([a-z]+)/i)[1].toLowerCase();
    ...
    p.jQueryDetection(),
    h.default.fn.emulateTransitionEnd = r,
    h.default.event.special[p.TRANSITION_END] = {
        bindType: o,
        delegateType: o,
        handle: function(e) {
            if (h.default(e.target).is(this))
    ...
    var a = "alert"
      ...
      , d = function() {
        ...
        ,
        e.dispose = function() {
            h.default.removeData(this._element, u),
            this._element = null
        }
        ,
        e._getRootElement = function(e) {
            ...
            i = i || h.default(e).closest(".alert")[0]
        }
        ,
        e._triggerCloseEvent = function(e) {
            var t = h.default.Event("close.bs.alert");
            return h.default(e).trigger(t),
            t
        }
        ,
        e._removeElement = function(t) {
            var i = this;
            if (h.default(t).removeClass("show"),
            h.default(t).hasClass("fade")) {
                var e = p.getTransitionDurationFromElement(t);
                h.default(t).one(p.TRANSITION_END, function(e) {
        ...
        e._destroyElement = function(e) {
            h.default(e).detach().trigger("closed.bs.alert").remove()
        }
        ,
    ...
    h.default(document).on("click.bs.alert.data-api", '[data-dismiss="alert"]', d._handleDismiss(new d)),
    h.default.fn[a] = d._jQueryInterface,
    h.default.fn[a].Constructor = d,
    h.default.fn[a].noConflict = function() {
        return h.default.fn[a] = c,
        d._jQueryInterface
    }
    ;
    var f = "button"
      ...
      , _ = function() {
        ...
        return e.toggle = function() {
            var e = !0
              , t = !0
              , i = h.default(this._element).closest('[data-toggle="buttons"]')[0];
            if (i) {
                var n = this._element.querySelector(b);
                if (n) {
                    if ("radio" === n.type)
                        if (n.checked && this._element.classList.contains(v))
                            ...
                            o && h.default(o).removeClass(v)
                        }
                    e && ("checkbox" !== n.type && "radio" !== n.type || (n.checked = !this._element.classList.contains(v)),
                    this.shouldAvoidTriggerChange || h.default(n).trigger("change")),
                    n.focus(),
                    t = !1
                }
            }
            ...
            e && h.default(this._element).toggleClass(v))
        }
        ,
        e.dispose = function() {
            h.default.removeData(this._element, m),
            this._element = null
        }
        ,
    ...
    h.default(document).on("click.bs.button.data-api", y, function(e) {
        var t = e.target
          , i = t;
        if (h.default(t).hasClass("btn") || (t = h.default(t).closest(".btn")[0]),
        !t || t.hasAttribute("disabled") || t.classList.contains("disabled"))
            ...
            "INPUT" !== i.tagName && "LABEL" === t.tagName || _._jQueryInterface.call(h.default(t), "toggle", "INPUT" === i.tagName)
        }
    }).on("focus.bs.button.data-api blur.bs.button.data-api", y, function(e) {
        var t = h.default(e.target).closest(".btn")[0];
        h.default(t).toggleClass("focus", /^focus(in)?$/.test(e.type))
    }),
    h.default(window).on("load.bs.button.data-api", function() {
        for (var e = [].slice.call(document.querySelectorAll('[data-toggle="buttons"] .btn')), t = 0, i = e.length; t < i; t++) {
            var n = e[t]
              , o = n.querySelector(b);
            o.checked || o.hasAttribute("checked") ? n.classList.add(v) : n.classList.remove(v)
        }
    ...
    h.default.fn[f] = _._jQueryInterface,
    h.default.fn[f].Constructor = _,
    h.default.fn[f].noConflict = function() {
        return h.default.fn[f] = g,
        _._jQueryInterface
    }
    ;
    var w = "carousel"
      ...
      , P = function() {
        ...
        e.to = function(e) {
            ...
            if (!(e > this._items.length - 1 || e < 0))
                if (this._isSliding)
                    h.default(this._element).one(I, function() {
                        return t.to(e)
                    });
                else {
                    if (i === e)
        ...
        ,
        e.dispose = function() {
            h.default(this._element).off(E),
            h.default.removeData(this._element, x),
            this._items = null,
            this._config = null,
            this._element = null,
            this._interval = null,
        ...
        e._addEventListeners = function() {
            var t = this;
            this._config.keyboard && h.default(this._element).on("keydown.bs.carousel", function(e) {
                return t._keydown(e)
            }),
            "hover" === this._config.pause && h.default(this._element).on("mouseenter.bs.carousel", function(e) {
                return t.pause(e)
        ...
        e._addTouchEventListeners = function() {
            ...
            if (this._touchSupported) {
                var i = function(e) {
                  ...
                  , n = function(e) {
                    t._pointerEvent && N[e.originalEvent.pointerType.toUpperCase()] && (t.touchDeltaX = e.originalEvent.clientX - t.touchStartX),
                    t._handleSwipe(),
                ...
                h.default(this._element.querySelectorAll(".carousel-item img")).on("dragstart.bs.carousel", function(e) {
                    return e.preventDefault()
                }),
                this._pointerEvent ? (h.default(this._element).on("pointerdown.bs.carousel", function(e) {
                    return i(e)
                }),
                h.default(this._element).on("pointerup.bs.carousel", function(e) {
                    return n(e)
                }),
                this._element.classList.add("pointer-event")) : (h.default(this._element).on("touchstart.bs.carousel", function(e) {
                    return i(e)
                }),
                h.default(this._element).on("touchmove.bs.carousel", function(e) {
                    return function(e) {
                        e.originalEvent.touches && 1 < e.originalEvent.touches.length ? t.touchDeltaX = 0 : t.touchDeltaX = e.originalEvent.touches[0].clientX - t.touchStartX
                    }(e)
                }),
                h.default(this._element).on("touchend.bs.carousel", function(e) {
                    return n(e)
                }))
            }
        }
        ...
        e._getItemByDirection = function(e, t) {
            ...
            if ((n && 0 === o || i && o === r) && !this._config.wrap)
                return t;
            var s = (o + (e === A ? -1 : 1)) % this._items.length;
        ...
        e._triggerSlideEvent = function(e, t) {
            ...
            return h.default(this._element).trigger(o),
            o
        }
        ,
        e._setActiveIndicatorElement = function(e) {
            if (this._indicatorsElement) {
                ...
                h.default(t).removeClass(D);
                var i = this._indicatorsElement.children[this._getItemIndex(e)];
                i && h.default(i).addClass(D)
            }
        }
        ,
        ...
        e._slide = function(e, t) {
            var i, n, o, r = this, s = this._element.querySelector(L), a = this._getItemIndex(s), l = t || s && this._getItemByDirection(e, s), u = this._getItemIndex(l), c = Boolean(this._interval);
            if (o = e === k ? (i = "carousel-item-left",
            n = "carousel-item-next",
            "left") : (i = "carousel-item-right",
            n = "carousel-item-prev",
            "right"),
            l && h.default(l).hasClass(D))
                this._isSliding = !1;
                ...
                var d = h.default.Event(I, {
                    relatedTarget: l,
                    direction: o,
                    from: a,
                    to: u
                });
                if (h.default(this._element).hasClass("slide")) {
                    h.default(l).addClass(n),
                    p.reflow(l),
                    h.default(s).addClass(i),
                    h.default(l).addClass(i);
                    var f = p.getTransitionDurationFromElement(s);
                    h.default(s).one(p.TRANSITION_END, function() {
                        h.default(l).removeClass(i + " " + n).addClass(D),
                        h.default(s).removeClass(D + " " + n + " " + i),
                        r._isSliding = !1,
                        setTimeout(function() {
                            return h.default(r._element).trigger(d)
                        }, 0)
                    }).emulateTransitionEnd(f)
                } else
                    h.default(s).removeClass(D),
                    h.default(l).addClass(D),
                    this._isSliding = !1,
                    h.default(this._element).trigger(d);
                c && this.cycle()
            }
        }
        ,
        r._jQueryInterface = function(n) {
            return this.each(function() {
                var e = h.default(this).data(x)
                  , t = l({}, T, h.default(this).data());
                "object" == typeof n && (t = l({}, t, n));
                var i = "string" == typeof n ? n : t.slide;
                if (e || (e = new r(this,t),
                h.default(this).data(x, e)),
                "number" == typeof n)
                    e.to(n);
        ...
        r._dataApiClickHandler = function(e) {
            ...
            if (t) {
                var i = h.default(t)[0];
                if (i && h.default(i).hasClass("carousel")) {
                    var n = l({}, h.default(i).data(), h.default(this).data())
                      , o = this.getAttribute("data-slide-to");
                    o && (n.interval = !1),
                    r._jQueryInterface.call(h.default(i), n),
                    o && h.default(i).data(x).to(o),
                    e.preventDefault()
                }
            }
        }
    ...
    h.default(document).on("click.bs.carousel.data-api", "[data-slide], [data-slide-to]", P._dataApiClickHandler),
    h.default(window).on("load.bs.carousel.data-api", function() {
        for (var e = [].slice.call(document.querySelectorAll('[data-ride="carousel"]')), t = 0, i = e.length; t < i; t++) {
            var n = h.default(e[t]);
            P._jQueryInterface.call(n, n.data())
        }
    }),
    h.default.fn[w] = P._jQueryInterface,
    h.default.fn[w].Constructor = P,
    h.default.fn[w].noConflict = function() {
        return h.default.fn[w] = S,
        P._jQueryInterface
    }
    ;
    var j = "collapse"
      ...
      , $ = function() {
        ...
        var e = a.prototype;
        return e.toggle = function() {
            h.default(this._element).hasClass(H) ? this.hide() : this.show()
        }
        ,
        e.show = function() {
            var e, t, i = this;
            if (!this._isTransitioning && !h.default(this._element).hasClass(H) && (this._parent && 0 === (e = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function(e) {
                return "string" == typeof i._config.parent ? e.getAttribute("data-parent") === i._config.parent : e.classList.contains(q)
            })).length && (e = null),
            !(e && (t = h.default(e).not(this._selector).data(O)) && t._isTransitioning))) {
                var n = h.default.Event("show.bs.collapse");
                if (h.default(this._element).trigger(n),
                !n.isDefaultPrevented()) {
                    e && (a._jQueryInterface.call(h.default(e).not(this._selector), "hide"),
                    t || h.default(e).data(O, null));
                    var o = this._getDimension();
                    h.default(this._element).removeClass(q).addClass(R),
                    this._element.style[o] = 0,
                    this._triggerArray.length && h.default(this._triggerArray).removeClass(F).attr("aria-expanded", !0),
                    this.setTransitioning(!0);
                    var r = "scroll" + (o[0].toUpperCase() + o.slice(1))
                      , s = p.getTransitionDurationFromElement(this._element);
                    h.default(this._element).one(p.TRANSITION_END, function() {
                        h.default(i._element).removeClass(R).addClass(q + " " + H),
                        i._element.style[o] = "",
                        i.setTransitioning(!1),
                        h.default(i._element).trigger("shown.bs.collapse")
        ...
        e.hide = function() {
            var e = this;
            if (!this._isTransitioning && h.default(this._element).hasClass(H)) {
                var t = h.default.Event("hide.bs.collapse");
                if (h.default(this._element).trigger(t),
                !t.isDefaultPrevented()) {
                    var i = this._getDimension();
                    this._element.style[i] = this._element.getBoundingClientRect()[i] + "px",
                    p.reflow(this._element),
                    h.default(this._element).addClass(R).removeClass(q + " " + H);
                    ...
                    if (0 < n)
                        for (var o = 0; o < n; o++) {
                            var r = this._triggerArray[o]
                              , s = p.getSelectorFromElement(r);
                            if (null !== s)
                                h.default([].slice.call(document.querySelectorAll(s))).hasClass(H) || h.default(r).addClass(F).attr("aria-expanded", !1)
                        }
                    this.setTransitioning(!0);
                    ...
                    h.default(this._element).one(p.TRANSITION_END, function() {
                        ...
                        h.default(e._element).removeClass(R).addClass(q).trigger("hidden.bs.collapse")
        ...
        ,
        e.dispose = function() {
            h.default.removeData(this._element, O),
            this._config = null,
            this._parent = null,
            this._element = null,
        ...
        ,
        e._getConfig = function(e) {
            return (e = l({}, z, e)).toggle = Boolean(e.toggle),
            p.typeCheckConfig(j, e, B),
            e
        }
        ,
        ...
        e._getParent = function() {
            var e, i = this;
            p.isElement(this._config.parent) ? (e = this._config.parent,
            ...
            return h.default(n).each(function(e, t) {
        ...
        e._addAriaAndCollapsedClass = function(e, t) {
            var i = h.default(e).hasClass(H);
            t.length && h.default(t).toggleClass(F, !i).attr("aria-expanded", i)
        }
        ,
        ...
        a._jQueryInterface = function(n) {
            return this.each(function() {
                var e = h.default(this)
                  , t = e.data(O)
                  , i = l({}, z, e.data(), "object" == typeof n && n ? n : {});
    ...
    h.default(document).on("click.bs.collapse.data-api", W, function(e) {
        "A" === e.currentTarget.tagName && e.preventDefault();
        var i = h.default(this)
          , t = p.getSelectorFromElement(this)
          , n = [].slice.call(document.querySelectorAll(t));
        h.default(n).each(function() {
            var e = h.default(this)
              , t = e.data(O) ? "toggle" : i.data();
            $._jQueryInterface.call(e, t)
        })
    }),
    h.default.fn[j] = $._jQueryInterface,
    h.default.fn[j].Constructor = $,
    h.default.fn[j].noConflict = function() {
        return h.default.fn[j] = M,
        $._jQueryInterface
    }
    ;
    ...
    var Y = V && window.Promise ? function(e) {
        var t = !1;
        return function() {
            t || (t = !0,
    ...
    function K(e) {
        ...
        var t = X(e)
          ...
          , n = t.overflowX
          , o = t.overflowY;
        return /(auto|scroll|overlay)/.test(i + o + n) ? e : K(G(e))
    }
    function J(e) {
    ...
    function te(e) {
        return 11 === e ? Z : 10 === e ? ee : Z || ee
    }
    function ie(e) {
        if (!e)
            return document.documentElement;
        for (var t = te(10) ? document.body : null, i = e.offsetParent || null; i === t && e.nextElementSibling; )
            i = (e = e.nextElementSibling).offsetParent;
        var n = i && i.nodeName;
        return n && "BODY" !== n && "HTML" !== n ? -1 !== ["TH", "TD", "TABLE"].indexOf(i.nodeName) && "static" === X(i, "position") ? ie(i) : i : e ? e.ownerDocument.documentElement : document.documentElement
    }
    function ne(e) {
    ...
    function oe(e, t) {
        ...
        if (e !== s && t !== s || n.contains(o))
            return function(e) {
                var t = e.nodeName;
                return "BODY" !== t && ("HTML" === t || ie(e.firstElementChild) === e)
            }(s) ? s : ie(s);
        var a = ne(e);
        return a.host ? oe(a.host, t) : oe(e, ne(t).host)
    }
    function re(e, t) {
    ...
    function ae(e, t, i, n) {
        return Math.max(t["offset" + e], t["scroll" + e], i["client" + e], i["offset" + e], i["scroll" + e], te(10) ? parseInt(i["offset" + e]) + parseInt(n["margin" + ("Height" === e ? "Top" : "Left")]) + parseInt(n["margin" + ("Height" === e ? "Bottom" : "Right")]) : 0)
    }
    function le(e) {
        var t = e.body
          , i = e.documentElement
          , n = te(10) && getComputedStyle(i);
        return {
            height: ae("Height", t, i, n),
            width: ae("Width", t, i, n)
        }
    }
    ...
    function pe(e) {
        ...
        var o = {
          ...
          , r = "HTML" === e.nodeName ? le(e.ownerDocument) : {}
    ...
    function me(e, t, i) {
        ...
        return (o && !n ? t.contains(l) : t === l && "BODY" !== l.nodeName) && (f = function(e, t, i) {
            var n = 2 < arguments.length && void 0 !== i && i
              , o = re(t, "top")
              , r = re(t, "left")
              , s = n ? -1 : 1;
    ...
    function ve(e, t, i, n, o) {
        ...
        if ("viewport" === n)
            ...
            var l = void 0;
            "scrollParent" === n ? "BODY" === (l = K(G(t))).nodeName && (l = e.ownerDocument.documentElement) : l = "window" === n ? e.ownerDocument.documentElement : n;
            var u = me(l, a, r);
    ...
    function Se(e, i, t) {
        return (void 0 === t ? e : e.slice(0, function(e, t, i) {
            ...
            e.enabled && Q(t) && (i.offsets.popper = he(i.offsets.popper),
            i.offsets.reference = he(i.offsets.reference),
            i = t(i, e))
        }),
        i
    }
    ...
    function Ae(e, t, i, n) {
        i.updateBound = n,
        ke(e).addEventListener("resize", i.updateBound, {
            passive: !0
        });
        var o = K(e);
    ...
    function Ie() {
        ...
        this.state = function(e, t) {
            return ke(e).removeEventListener("resize", t.updateBound),
    ...
    function Le(i, n) {
        Object.keys(n).forEach(function(e) {
            var t = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(e) && De(n[e]) && (t = "px"),
            i.style[e] = n[e] + t
        })
    }
    var Ne = V && /Firefox/i.test(navigator.userAgent);
    function Pe(e, t, i) {
        var n = Ee(e, function(e) {
            return e.name === t
        })
    ...
    function Me(e, t) {
        var i = 1 < arguments.length && void 0 !== t && t
          , n = Oe.indexOf(e)
          , o = Oe.slice(n + 1).concat(Oe.slice(0, n));
    ...
    function qe(e, o, r, t) {
        var s = [0, 0]
          ...
          , n = i.indexOf(Ee(i, function(e) {
            return -1 !== e.search(/,|\s/)
        }));
        i[n] && -1 === i[n].indexOf(",") && console.warn("Offsets separated by white space(s) are deprecated, use a comma (,) instead.");
        var l = /\s*,\s*|\s+/
          , u = -1 !== n ? [i.slice(0, n).concat([i[n].split(l)[0]]), [i[n].split(l)[1]].concat(i.slice(n + 1))] : [i];
    ...
    var Re = {
        ...
        modifiers: {
                ...
                fn: function(e) {
                    ...
                    if (n) {
                        var o = e.offsets
                          ...
                          , c = {
                            start: de({}, l, r[l]),
                            end: de({}, l, r[l] + r[u] - s[u])
                        };
                        e.offsets.popper = fe({}, s, c[n])
                    }
                    return e
                }
            },
            ...
            preventOverflow: {
                ...
                enabled: !0,
                fn: function(e, n) {
                    var t = n.boundariesElement || ie(e.instance.popper);
                    ...
                    o.left = "",
                    o[i] = "";
                    var l = ve(e.instance.popper, e.instance.reference, n.padding, t, e.positionFixed);
                    o.top = r,
                    o.left = s,
                    o[i] = a,
                    n.boundaries = l;
                    var u = n.priority
                      ...
                      , d = {
                        primary: function(e) {
                            var t = c[e];
                            return c[e] < l[e] && !n.escapeWithReference && (t = Math.max(c[e], l[e])),
                            de({}, e, t)
                        },
                        secondary: function(e) {
                            var t = "right" === e ? "left" : "top"
                              , i = c[t];
                            return c[e] > l[e] && !n.escapeWithReference && (i = Math.min(c[t], l[e] - ("right" === e ? c.width : c.height))),
                            de({}, t, i)
                        }
                    };
            ...
            keepTogether: {
                ...
                fn: function(e) {
                    var t = e.offsets
                      ...
                      , l = s ? "left" : "top"
                      , u = s ? "width" : "height";
                    return i[a] < r(n[l]) && (e.offsets.popper[l] = r(n[l]) - i[u]),
            ...
            arrow: {
                ...
                fn: function(e, t) {
                    ...
                    var o = e.placement.split("-")[0]
                      ...
                      , h = l ? "bottom" : "right"
                      , p = _e(n)[u];
                    a[h] - p < s[d] && (e.offsets.popper[d] -= s[d] - (a[h] - p)),
                    a[d] + p > s[h] && (e.offsets.popper[d] += a[d] + p - s[h]),
                    ...
                    e.arrowElement = n,
                    e.offsets.arrow = (de(i = {}, d, Math.round(b)),
                    de(i, f, ""),
                    i),
                    e
                },
            ...
            flip: {
                ...
                enabled: !0,
                fn: function(m, g) {
                    if (Te(m.instance.modifiers, "inner"))
                        return m;
                    if (m.flipped && m.placement === m.originalPlacement)
                        return m;
                    var v = ve(m.instance.popper, m.instance.reference, g.padding, g.boundariesElement, m.positionFixed)
                    ...
                    return w.forEach(function(e, t) {
                        ...
                        var i = m.offsets.popper
                          ...
                          , l = o(i.top) < o(v.top)
                          , u = o(i.bottom) > o(v.bottom)
                          , c = "left" === y && s || "right" === y && a || "top" === y && l || "bottom" === y && u
                          , d = -1 !== ["top", "bottom"].indexOf(y)
                          , f = !!g.flipVariations && (d && "start" === _ && s || d && "end" === _ && a || !d && "start" === _ && l || !d && "end" === _ && u)
                          , h = !!g.flipVariationsByContent && (d && "start" === _ && a || d && "end" === _ && s || !d && "start" === _ && u || !d && "end" === _ && l)
                          , p = f || h;
                        (r || c || p) && (m.flipped = !0,
                        (r || c) && (y = w[t + 1]),
                        p && (_ = function(e) {
                        ...
                        m.placement = y + (_ ? "-" + _ : ""),
                        m.offsets.popper = fe({}, m.offsets.popper, xe(m.instance.popper, m.offsets.reference, m.placement)),
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    var i = t.x
                      , n = t.y
                      , o = e.offsets.popper
                      , r = Ee(e.instance.modifiers, function(e) {
                        return "applyStyle" === e.name
                    }).gpuAcceleration;
                    void 0 !== r && console.warn("WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will not be supported in future versions of Popper.js!");
                    var s = void 0 !== r ? r : t.gpuAcceleration
                      , a = ie(e.instance.popper)
                      , l = pe(a)
                      , u = {
                        position: o.position
                    }
                      ...
                      , p = void 0
                      , m = void 0;
                    if (m = "bottom" == d ? "HTML" === a.nodeName ? -a.clientHeight + c.bottom : -l.height + c.bottom : c.top,
                    p = "right" == f ? "HTML" === a.nodeName ? -a.clientWidth + c.right : -l.width + c.right : c.left,
                    s && h)
                    ...
                    return e.attributes = fe({}, y, e.attributes),
                    e.styles = fe({}, u, e.styles),
            ...
            applyStyle: {
                ...
                onLoad: function(e, t, i, n, o) {
                    var r = be(o, t, e, i.positionFixed)
                      , s = ye(i.placement, r, t, e, i.modifiers.flip.boundariesElement, i.modifiers.flip.padding);
        ...
        value: function() {
            return function() {
                if (!this.state.isDestroyed) {
                    ...
                    e.offsets.reference = be(this.state, this.popper, this.reference, this.options.positionFixed),
    ...
    function We(e, t) {
        ...
        Object.keys(fe({}, We.Defaults.modifiers, n.modifiers)).forEach(function(e) {
            i.options.modifiers[e] = fe({}, We.Defaults.modifiers[e] || {}, n.modifiers ? n.modifiers[e] : {})
        }),
        ...
        this.modifiers.forEach(function(e) {
            e.enabled && Q(e.onLoad) && e.onLoad(i.reference, i.popper, i.options, e, i.state)
        }),
        this.update();
    ...
    var $e = "dropdown"
      ...
      , at = function() {
        ...
        var e = u.prototype;
        return e.toggle = function() {
            if (!this._element.disabled && !h.default(this._element).hasClass(et)) {
                var e = h.default(this._menu).hasClass(tt);
                u._clearMenus(),
                e || this.show(!0)
            }
        }
        ...
        e.show = function(e) {
            if (void 0 === e && (e = !1),
            !(this._element.disabled || h.default(this._element).hasClass(et) || h.default(this._menu).hasClass(tt))) {
                var t = {
                    relatedTarget: this._element
                }
                  , i = h.default.Event("show.bs.dropdown", t)
                  , n = u._getParentFromElement(this._element);
                if (h.default(n).trigger(i),
                !i.isDefaultPrevented()) {
                    if (!this._inNavbar && e) {
                        if (void 0 === Fe)
                            throw new TypeError("Bootstrap's dropdowns require Popper (https://popper.js.org)");
                        var o = this._element;
                        "parent" === this._config.reference ? o = n : p.isElement(this._config.reference) && (o = this._config.reference,
                        void 0 !== this._config.reference.jquery && (o = this._config.reference[0])),
                        "scrollParent" !== this._config.boundary && h.default(n).addClass("position-static"),
                        this._popper = new Fe(o,this._menu,this._getPopperConfig())
                    }
                    "ontouchstart"in document.documentElement && 0 === h.default(n).closest(".navbar-nav").length && h.default(document.body).children().on("mouseover", null, h.default.noop),
                    this._element.focus(),
                    this._element.setAttribute("aria-expanded", !0),
                    h.default(this._menu).toggleClass(tt),
                    h.default(n).toggleClass(tt).trigger(h.default.Event("shown.bs.dropdown", t))
                }
            }
        }
        ,
        e.hide = function() {
            if (!this._element.disabled && !h.default(this._element).hasClass(et) && h.default(this._menu).hasClass(tt)) {
                var e = {
                    relatedTarget: this._element
                }
                  , t = h.default.Event(Ge, e)
                  , i = u._getParentFromElement(this._element);
                h.default(i).trigger(t),
                t.isDefaultPrevented() || (this._popper && this._popper.destroy(),
                h.default(this._menu).toggleClass(tt),
                h.default(i).toggleClass(tt).trigger(h.default.Event(Ke, e)))
            }
        }
        ,
        e.dispose = function() {
            h.default.removeData(this._element, Ve),
            h.default(this._element).off(Ue),
            this._element = null,
        ...
        e._addEventListeners = function() {
            var t = this;
            h.default(this._element).on("click.bs.dropdown", function(e) {
                e.preventDefault(),
                e.stopPropagation(),
                t.toggle()
            })
        ...
        ,
        e._getConfig = function(e) {
            return e = l({}, this.constructor.Default, h.default(this._element).data(), e),
            p.typeCheckConfig($e, e, this.constructor.DefaultType),
            e
        }
        ,
        ...
        e._getPlacement = function() {
            var e = h.default(this._element.parentNode)
              , t = "bottom-start";
            return e.hasClass("dropup") ? t = h.default(this._menu).hasClass(it) ? "top-end" : "top-start" : e.hasClass("dropright") ? t = "right-start" : e.hasClass("dropleft") ? t = "left-start" : h.default(this._menu).hasClass(it) && (t = "bottom-end"),
            t
        }
        ,
        ...
        u._jQueryInterface = function(t) {
            return this.each(function() {
                var e = h.default(this).data(Ve);
                if (e || (e = new u(this,"object" == typeof t ? t : null),
                h.default(this).data(Ve, e)),
                "string" == typeof t) {
                    if (void 0 === e[t])
        ...
        u._clearMenus = function(e) {
            if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which))
                for (var t = [].slice.call(document.querySelectorAll(nt)), i = 0, n = t.length; i < n; i++) {
                    var o = u._getParentFromElement(t[i])
                      , r = h.default(t[i]).data(Ve)
                      , s = {
                        relatedTarget: t[i]
                    };
                    ...
                    r) {
                        var a = r._menu;
                        if (h.default(o).hasClass(tt) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && h.default.contains(o, e.target))) {
                            var l = h.default.Event(Ge, s);
                            h.default(o).trigger(l),
                            l.isDefaultPrevented() || ("ontouchstart"in document.documentElement && h.default(document.body).children().off("mouseover", null, h.default.noop),
                            t[i].setAttribute("aria-expanded", "false"),
                            r._popper && r._popper.destroy(),
                            h.default(a).removeClass(tt),
                            h.default(o).removeClass(tt).trigger(h.default.Event(Ke, s)))
                        }
                    }
                }
        }
        ...
        u._dataApiKeydownHandler = function(e) {
            if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || h.default(e.target).closest(ot).length)) : Xe.test(e.which)) && !this.disabled && !h.default(this).hasClass(et)) {
                var t = u._getParentFromElement(this)
                  , i = h.default(t).hasClass(tt);
                if (i || 27 !== e.which) {
                    if (e.preventDefault(),
                    e.stopPropagation(),
                    !i || 27 === e.which || 32 === e.which)
                        return 27 === e.which && h.default(t.querySelector(nt)).trigger("focus"),
                        void h.default(this).trigger("click");
    ...
    h.default(document).on(Ze, nt, at._dataApiKeydownHandler).on(Ze, ot, at._dataApiKeydownHandler).on(Je + " keyup.bs.dropdown.data-api", at._clearMenus).on(Je, nt, function(e) {
        e.preventDefault(),
        e.stopPropagation(),
        at._jQueryInterface.call(h.default(this), "toggle")
    }).on(Je, ".dropdown form", function(e) {
        e.stopPropagation()
    }),
    h.default.fn[$e] = at._jQueryInterface,
    h.default.fn[$e].Constructor = at,
    h.default.fn[$e].noConflict = function() {
        return h.default.fn[$e] = Qe,
        at._jQueryInterface
    }
    ;
    var lt = "modal"
      ...
      , kt = function() {
        ...
        e.show = function(e) {
            ...
            if (!this._isShown && !this._isTransitioning) {
                h.default(this._element).hasClass(xt) && (this._isTransitioning = !0);
                var i = h.default.Event(mt, {
                    relatedTarget: e
                });
                h.default(this._element).trigger(i),
                ...
                h.default(this._element).on(yt, '[data-dismiss="modal"]', function(e) {
                    return t.hide(e)
                }),
                h.default(this._dialog).on(_t, function() {
                    h.default(t._element).one("mouseup.dismiss.bs.modal", function(e) {
        ...
        e.hide = function(e) {
            ...
            this._isShown && !this._isTransitioning) {
                var i = h.default.Event("hide.bs.modal");
                if (h.default(this._element).trigger(i),
                this._isShown && !i.isDefaultPrevented()) {
                    this._isShown = !1;
                    var n = h.default(this._element).hasClass(xt);
                    if (n && (this._isTransitioning = !0),
                    this._setEscapeEvent(),
                    this._setResizeEvent(),
                    h.default(document).off(gt),
                    h.default(this._element).removeClass(Et),
                    h.default(this._element).off(yt),
                    h.default(this._dialog).off(_t),
                    n) {
                        var o = p.getTransitionDurationFromElement(this._element);
                        h.default(this._element).one(p.TRANSITION_END, function(e) {
        ...
        e.dispose = function() {
            [window, this._element, this._dialog].forEach(function(e) {
                return h.default(e).off(ct)
            }),
            h.default(document).off(gt),
            h.default.removeData(this._element, ut),
            this._config = null,
            this._element = null,
            this._dialog = null,
            this._backdrop = null,
        ...
        e._getConfig = function(e) {
            return e = l({}, ft, e),
            p.typeCheckConfig(lt, e, ht),
            e
        }
        ,
        e._triggerBackdropTransition = function() {
            var e = this
              , t = h.default.Event("hidePrevented.bs.modal");
            if (h.default(this._element).trigger(t),
            !t.isDefaultPrevented()) {
                var i = this._element.scrollHeight > document.documentElement.clientHeight;
                i || (this._element.style.overflowY = "hidden"),
                this._element.classList.add(St);
                var n = p.getTransitionDurationFromElement(this._dialog);
                h.default(this._element).off(p.TRANSITION_END),
                h.default(this._element).one(p.TRANSITION_END, function() {
                    e._element.classList.remove(St),
                    i || h.default(e._element).one(p.TRANSITION_END, function() {
        ...
        e._showElement = function(e) {
            var t = this
              , i = h.default(this._element).hasClass(xt)
            ...
            h.default(this._dialog).hasClass("modal-dialog-scrollable") && n ? n.scrollTop = 0 : this._element.scrollTop = 0,
            i && p.reflow(this._element),
            h.default(this._element).addClass(Et),
            this._config.focus && this._enforceFocus();
            function o() {
                t._config.focus && t._element.focus(),
                t._isTransitioning = !1,
                h.default(t._element).trigger(r)
            }
            var r = h.default.Event("shown.bs.modal", {
                relatedTarget: e
            });
            if (i) {
                var s = p.getTransitionDurationFromElement(this._dialog);
                h.default(this._dialog).one(p.TRANSITION_END, o).emulateTransitionEnd(s)
            } else
                o()
        }
        ,
        e._enforceFocus = function() {
            var t = this;
            h.default(document).off(gt).on(gt, function(e) {
                document !== e.target && t._element !== e.target && 0 === h.default(t._element).has(e.target).length && t._element.focus()
            })
        }
        ,
        e._setEscapeEvent = function() {
            var t = this;
            this._isShown ? h.default(this._element).on(bt, function(e) {
                t._config.keyboard && 27 === e.which ? (e.preventDefault(),
                t.hide()) : t._config.keyboard || 27 !== e.which || t._triggerBackdropTransition()
            }) : this._isShown || h.default(this._element).off(bt)
        }
        ,
        e._setResizeEvent = function() {
            var t = this;
            this._isShown ? h.default(window).on(vt, function(e) {
                return t.handleUpdate(e)
            }) : h.default(window).off(vt)
        }
        ,
        e._hideModal = function() {
            ...
            this._isTransitioning = !1,
            this._showBackdrop(function() {
                h.default(document.body).removeClass(wt),
                e._resetAdjustments(),
                e._resetScrollbar(),
                h.default(e._element).trigger(pt)
            })
        }
        ,
        e._removeBackdrop = function() {
            this._backdrop && (h.default(this._backdrop).remove(),
            this._backdrop = null)
        }
        ,
        e._showBackdrop = function(e) {
            var t = this
              , i = h.default(this._element).hasClass(xt) ? xt : "";
            if (this._isShown && this._config.backdrop) {
                if (this._backdrop = document.createElement("div"),
                this._backdrop.className = "modal-backdrop",
                i && this._backdrop.classList.add(i),
                h.default(this._backdrop).appendTo(document.body),
                h.default(this._element).on(yt, function(e) {
                    t._ignoreBackdropClick ? t._ignoreBackdropClick = !1 : e.target === e.currentTarget && ("static" === t._config.backdrop ? t._triggerBackdropTransition() : t.hide())
                }),
                i && p.reflow(this._backdrop),
                h.default(this._backdrop).addClass(Et),
                !e)
                    return;
                if (!i)
                    return void e();
                var n = p.getTransitionDurationFromElement(this._backdrop);
                h.default(this._backdrop).one(p.TRANSITION_END, e).emulateTransitionEnd(n)
            } else if (!this._isShown && this._backdrop) {
                h.default(this._backdrop).removeClass(Et);
                var o = function() {
                    t._removeBackdrop(),
                    e && e()
                };
                if (h.default(this._element).hasClass(xt)) {
                    var r = p.getTransitionDurationFromElement(this._backdrop);
                    h.default(this._backdrop).one(p.TRANSITION_END, o).emulateTransitionEnd(r)
                } else
                    o()
            } else
                e && e()
            ...
            if (this._isBodyOverflowing) {
                ...
                h.default(e).each(function(e, t) {
                    var i = t.style.paddingRight
                      , n = h.default(t).css("padding-right");
                    h.default(t).data("padding-right", i).css("padding-right", parseFloat(n) + o._scrollbarWidth + "px")
                }),
                h.default(t).each(function(e, t) {
                    var i = t.style.marginRight
                      , n = h.default(t).css("margin-right");
                    h.default(t).data("margin-right", i).css("margin-right", parseFloat(n) - o._scrollbarWidth + "px")
                });
                var i = document.body.style.paddingRight
                  , n = h.default(document.body).css("padding-right");
                h.default(document.body).data("padding-right", i).css("padding-right", parseFloat(n) + this._scrollbarWidth + "px")
            }
            h.default(document.body).addClass(wt)
        }
        ,
        e._resetScrollbar = function() {
            var e = [].slice.call(document.querySelectorAll(Tt));
            h.default(e).each(function(e, t) {
                var i = h.default(t).data("padding-right");
                h.default(t).removeData("padding-right"),
                t.style.paddingRight = i || ""
            });
            var t = [].slice.call(document.querySelectorAll(Ct));
            h.default(t).each(function(e, t) {
                var i = h.default(t).data("margin-right");
                void 0 !== i && h.default(t).css("margin-right", i).removeData("margin-right")
            });
            var i = h.default(document.body).data("padding-right");
            h.default(document.body).removeData("padding-right"),
        ...
        o._jQueryInterface = function(i, n) {
            return this.each(function() {
                var e = h.default(this).data(ut)
                  , t = l({}, ft, h.default(this).data(), "object" == typeof i && i ? i : {});
                if (e || (e = new o(this,t),
                h.default(this).data(ut, e)),
                "string" == typeof i) {
                    if (void 0 === e[i])
                        throw new TypeError('No method named "' + i + '"');
                    e[i](n)
    ...
    h.default(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', function(e) {
        var t, i = this, n = p.getSelectorFromElement(this);
        n && (t = document.querySelector(n));
        var o = h.default(t).data(ut) ? "toggle" : l({}, h.default(t).data(), h.default(this).data());
        "A" !== this.tagName && "AREA" !== this.tagName || e.preventDefault();
        var r = h.default(t).one(mt, function(e) {
            e.isDefaultPrevented() || r.one(pt, function() {
                h.default(i).is(":visible") && i.focus()
            })
        });
        kt._jQueryInterface.call(h.default(t), o, this)
    }),
    h.default.fn[lt] = kt._jQueryInterface,
    h.default.fn[lt].Constructor = kt,
    h.default.fn[lt].noConflict = function() {
        return h.default.fn[lt] = dt,
        kt._jQueryInterface
    }
    ;
        ...
        for (var i = (new window.DOMParser).parseFromString(e, "text/html"), a = Object.keys(s), l = [].slice.call(i.body.querySelectorAll("*")), n = function(e, t) {
            ...
            o.forEach(function(e) {
                !function(e, t) {
                    ...
                    if (-1 !== t.indexOf(i))
                        return -1 === At.indexOf(i) || Boolean(e.nodeValue.match(Dt) || e.nodeValue.match(Lt));
    ...
    var Pt = "tooltip"
      ...
      , Xt = function() {
            ...
            if (this._isEnabled)
                if (e) {
                    var t = this.constructor.DATA_KEY
                      , i = h.default(e.currentTarget).data(t);
                    i || (i = new this.constructor(e.currentTarget,this._getDelegateConfig()),
                    h.default(e.currentTarget).data(t, i)),
                    i._activeTrigger.click = !i._activeTrigger.click,
                    i._isWithActiveTrigger() ? i._enter(null, i) : i._leave(null, i)
                } else {
                    if (h.default(this.getTipElement()).hasClass(Ut))
        ...
        e.dispose = function() {
            ...
            h.default.removeData(this.element, this.constructor.DATA_KEY),
            h.default(this.element).off(this.constructor.EVENT_KEY),
            h.default(this.element).closest(".modal").off("hide.bs.modal", this._hideModalHandler),
            this.tip && h.default(this.tip).remove(),
        ...
        e.show = function() {
            var t = this;
            if ("none" === h.default(this.element).css("display"))
                throw new Error("Please use show on visible elements");
            var e = h.default.Event(this.constructor.Event.SHOW);
            if (this.isWithContent() && this._isEnabled) {
                h.default(this.element).trigger(e);
                var i = p.findShadowRoot(this.element)
                  , n = h.default.contains(null !== i ? i : this.element.ownerDocument.documentElement, this.element);
                ...
                this.setContent(),
                this.config.animation && h.default(o).addClass(Vt);
                var s = "function" == typeof this.config.placement ? this.config.placement.call(this, o, this.element) : this.config.placement
                  , a = this._getAttachment(s);
                this.addAttachmentClass(a);
                var l = this._getContainer();
                h.default(o).data(this.constructor.DATA_KEY, this),
                h.default.contains(this.element.ownerDocument.documentElement, this.tip) || h.default(o).appendTo(l),
                h.default(this.element).trigger(this.constructor.Event.INSERTED),
                this._popper = new Fe(this.element,o,this._getPopperConfig(a)),
                h.default(o).addClass(Ut),
                h.default(o).addClass(this.config.customClass),
                "ontouchstart"in document.documentElement && h.default(document.body).children().on("mouseover", null, h.default.noop);
                var u = function() {
                    t.config.animation && t._fixTransition();
                    var e = t._hoverState;
                    t._hoverState = null,
                    h.default(t.element).trigger(t.constructor.Event.SHOWN),
                    "out" === e && t._leave(null, t)
                };
                if (h.default(this.tip).hasClass(Vt)) {
                    var c = p.getTransitionDurationFromElement(this.tip);
                    h.default(this.tip).one(p.TRANSITION_END, u).emulateTransitionEnd(c)
                } else
                    u()
            }
        }
        ...
        e.hide = function(e) {
            function t() {
                ...
                h.default(i.element).trigger(i.constructor.Event.HIDDEN),
                null !== i._popper && i._popper.destroy(),
                e && e()
            }
            var i = this
              , n = this.getTipElement()
              , o = h.default.Event(this.constructor.Event.HIDE);
            if (h.default(this.element).trigger(o),
            !o.isDefaultPrevented()) {
                if (h.default(n).removeClass(Ut),
                "ontouchstart"in document.documentElement && h.default(document.body).children().off("mouseover", null, h.default.noop),
                this._activeTrigger.click = !1,
                this._activeTrigger[Qt] = !1,
                this._activeTrigger[Yt] = !1,
                h.default(this.tip).hasClass(Vt)) {
                    var r = p.getTransitionDurationFromElement(n);
                    h.default(n).one(p.TRANSITION_END, t).emulateTransitionEnd(r)
                } else
                    t();
                this._hoverState = ""
            }
        ...
        e.addAttachmentClass = function(e) {
            h.default(this.getTipElement()).addClass(zt + "-" + e)
        }
        ,
        e.getTipElement = function() {
            return this.tip = this.tip || h.default(this.config.template)[0],
            this.tip
        }
        ,
        e.setContent = function() {
            var e = this.getTipElement();
            this.setElementContent(h.default(e.querySelectorAll(".tooltip-inner")), this.getTitle()),
            h.default(e).removeClass(Vt + " " + Ut)
        }
        ,
        e.setElementContent = function(e, t) {
            ...
            e.html(t)) : e.text(t) : this.config.html ? h.default(t).parent().is(e) || e.empty().append(t) : e.text(h.default(t).text())
        }
        ,
        e.getTitle = function() {
        ...
        e._setListeners = function() {
            ...
            this.config.trigger.split(" ").forEach(function(e) {
                if ("click" === e)
                    h.default(n.element).on(n.constructor.Event.CLICK, n.config.selector, function(e) {
                        return n.toggle(e)
                    });
                else if ("manual" !== e) {
                    var t = e === Yt ? n.constructor.Event.MOUSEENTER : n.constructor.Event.FOCUSIN
                      , i = e === Yt ? n.constructor.Event.MOUSELEAVE : n.constructor.Event.FOCUSOUT;
                    h.default(n.element).on(t, n.config.selector, function(e) {
                        return n._enter(e)
            ...
            ,
            h.default(this.element).closest(".modal").on("hide.bs.modal", this._hideModalHandler),
        ...
        e._enter = function(e, t) {
            ...
            (t = t || h.default(e.currentTarget).data(i)) || (t = new this.constructor(e.currentTarget,this._getDelegateConfig()),
            h.default(e.currentTarget).data(i, t)),
            e && (t._activeTrigger["focusin" === e.type ? Qt : Yt] = !0),
            h.default(t.getTipElement()).hasClass(Ut) || t._hoverState === Wt ? t._hoverState = Wt : (clearTimeout(t._timeout),
            t._hoverState = Wt,
        ...
        e._leave = function(e, t) {
            ...
            (t = t || h.default(e.currentTarget).data(i)) || (t = new this.constructor(e.currentTarget,this._getDelegateConfig()),
            h.default(e.currentTarget).data(i, t)),
            e && (t._activeTrigger["focusout" === e.type ? Qt : Yt] = !1),
        ...
        e._getConfig = function(e) {
            ...
            p.typeCheckConfig(Pt, e, this.constructor.DefaultType),
        ...
        e._fixTransition = function() {
            ...
            null === e.getAttribute("x-placement") && (h.default(e).removeClass(Vt),
        ...
        o._jQueryInterface = function(n) {
            return this.each(function() {
                var e = h.default(this)
                  , t = e.data(jt)
                  , i = "object" == typeof n && n;
                if ((t || !/dispose|hide/.test(n)) && (t || (t = new o(this,i),
                e.data(jt, t)),
                "string" == typeof n)) {
                    if (void 0 === t[n])
                        throw new TypeError('No method named "' + n + '"');
    ...
    h.default.fn[Pt] = Xt._jQueryInterface,
    h.default.fn[Pt].Constructor = Xt,
    h.default.fn[Pt].noConflict = function() {
        return h.default.fn[Pt] = Mt,
        Xt._jQueryInterface
    }
    ;
    var Gt = "popover"
      ...
      , ri = function(e) {
        ...
        t.addAttachmentClass = function(e) {
            h.default(this.getTipElement()).addClass(ei + "-" + e)
        }
        ,
    ...
    h.default.fn[Gt] = ri._jQueryInterface,
    h.default.fn[Gt].Constructor = ri,
    h.default.fn[Gt].noConflict = function() {
        return h.default.fn[Gt] = Zt,
        ri._jQueryInterface
    }
    ;
    var si = "scrollspy"
      ...
      , vi = function() {
        function i(e, t) {
            ...
            this._config = this._getConfig(t),
            this._selector = this._config.target + " " + pi + "," + this._config.target + " " + mi + "," + this._config.target + " .dropdown-item",
            this._offsets = [],
            this._targets = [],
            this._activeTarget = null,
            this._scrollHeight = 0,
            h.default(this._scrollElement).on("scroll.bs.scrollspy", function(e) {
                return i._process(e)
            }),
            this.refresh(),
            this._process()
        ...
        ,
        e.dispose = function() {
            h.default.removeData(this._element, ai),
            h.default(this._scrollElement).off(li),
            this._element = null,
        ...
        ,
        e._getConfig = function(e) {
            if ("string" != typeof (e = l({}, ci, "object" == typeof e && e ? e : {})).target && p.isElement(e.target)) {
                var t = h.default(e.target).attr("id");
                t || (t = p.getUID(si),
                h.default(e.target).attr("id", t)),
                e.target = "#" + t
            }
            return p.typeCheckConfig(si, e, di),
            e
        }
        ,
        ...
        e._activate = function(t) {
            ...
            var e = this._selector.split(",").map(function(e) {
              ...
              , i = h.default([].slice.call(document.querySelectorAll(e.join(","))));
            i.hasClass("dropdown-item") ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(fi),
            i.addClass(fi)) : (i.addClass(fi),
            i.parents(hi).prev(pi + ", " + mi).addClass(fi),
            i.parents(hi).prev(".nav-item").children(pi).addClass(fi)),
            h.default(this._scrollElement).trigger("activate.bs.scrollspy", {
                relatedTarget: t
            })
        }
        ,
        ...
        i._jQueryInterface = function(t) {
            return this.each(function() {
                var e = h.default(this).data(ai);
                if (e || (e = new i(this,"object" == typeof t && t),
                h.default(this).data(ai, e)),
                "string" == typeof t) {
                    if (void 0 === e[t])
                        throw new TypeError('No method named "' + t + '"');
                    e[t]()
    ...
    h.default.fn[si] = vi._jQueryInterface,
    h.default.fn[si].Constructor = vi,
    h.default.fn[si].noConflict = function() {
        return h.default.fn[si] = ui,
        vi._jQueryInterface
    }
    ;
    var yi = "bs.tab"
      ...
      , Ei = function() {
        ...
        return e.show = function() {
            var i = this;
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && h.default(this._element).hasClass(_i) || h.default(this._element).hasClass("disabled"))) {
                var e, n, t = h.default(this._element).closest(".nav, .list-group")[0], o = p.getSelectorFromElement(this._element);
                if (t) {
                    var r = "UL" === t.nodeName || "OL" === t.nodeName ? xi : wi;
                    n = (n = h.default.makeArray(h.default(t).find(r)))[n.length - 1]
                }
                var s = h.default.Event("hide.bs.tab", {
                    relatedTarget: this._element
                })
                  , a = h.default.Event("show.bs.tab", {
                    relatedTarget: n
                });
                if (n && h.default(n).trigger(s),
                h.default(this._element).trigger(a),
                !a.isDefaultPrevented() && !s.isDefaultPrevented()) {
                    o && (e = document.querySelector(o)),
                    this._activate(this._element, t);
                    var l = function() {
                        var e = h.default.Event("hidden.bs.tab", {
                            relatedTarget: i._element
                        })
                          , t = h.default.Event("shown.bs.tab", {
                            relatedTarget: n
                        });
                        h.default(n).trigger(e),
                        h.default(i._element).trigger(t)
                    };
        ...
        ,
        e.dispose = function() {
            h.default.removeData(this._element, yi),
            this._element = null
        }
        ,
        e._activate = function(e, t, i) {
            ...
            var o = this
              , r = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? h.default(t).children(wi) : h.default(t).find(xi))[0]
              , s = i && r && h.default(r).hasClass("fade");
            if (r && s) {
                var a = p.getTransitionDurationFromElement(r);
                h.default(r).removeClass("show").one(p.TRANSITION_END, n).emulateTransitionEnd(a)
            } else
                n()
        }
        ,
        e._transitionComplete = function(e, t, i) {
            if (t) {
                h.default(t).removeClass(_i);
                var n = h.default(t.parentNode).find("> .dropdown-menu .active")[0];
                n && h.default(n).removeClass(_i),
                "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !1)
            }
            if (h.default(e).addClass(_i),
            "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0),
            p.reflow(e),
            e.classList.contains("fade") && e.classList.add("show"),
            e.parentNode && h.default(e.parentNode).hasClass("dropdown-menu")) {
                var o = h.default(e).closest(".dropdown")[0];
                if (o) {
                    var r = [].slice.call(o.querySelectorAll(".dropdown-toggle"));
                    h.default(r).addClass(_i)
                }
    ...
    h.default(document).on("click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(e) {
        e.preventDefault(),
        Ei._jQueryInterface.call(h.default(this), "show")
    }),
    h.default.fn.tab = Ei._jQueryInterface,
    h.default.fn.tab.Constructor = Ei,
    h.default.fn.tab.noConflict = function() {
        return h.default.fn.tab = bi,
        Ei._jQueryInterface
    }
    ;
    var Si = "toast"
      ...
      , Pi = function() {
        ...
        return e.show = function() {
            var e = this
              , t = h.default.Event("show.bs.toast");
            if (h.default(this._element).trigger(t),
            !t.isDefaultPrevented()) {
                this._clearTimeout(),
                ...
                var i = function() {
                    ...
                    e._element.classList.add(Ii),
                    h.default(e._element).trigger("shown.bs.toast"),
                ...
                this._config.animation) {
                    ...
                    h.default(this._element).one(p.TRANSITION_END, i).emulateTransitionEnd(n)
                } else
                    i()
            }
        }
        ,
        e.hide = function() {
            if (this._element.classList.contains(Ii)) {
                var e = h.default.Event("hide.bs.toast");
                h.default(this._element).trigger(e),
        ...
        e.dispose = function() {
            ...
            h.default(this._element).off(Ai),
            h.default.removeData(this._element, Ti),
            this._element = null,
            this._config = null
        }
        ,
        e._getConfig = function(e) {
            return e = l({}, Ni, h.default(this._element).data(), "object" == typeof e && e ? e : {}),
            p.typeCheckConfig(Si, e, this.constructor.DefaultType),
            e
        }
        ,
        e._setListeners = function() {
            var e = this;
            h.default(this._element).on(Ai, '[data-dismiss="toast"]', function() {
                return e.hide()
            })
        }
        ,
        e._close = function() {
            function e() {
                ...
                h.default(t._element).trigger("hidden.bs.toast")
            }
            var t = this;
            if (this._element.classList.remove(Ii),
            this._config.animation) {
                var i = p.getTransitionDurationFromElement(this._element);
                h.default(this._element).one(p.TRANSITION_END, e).emulateTransitionEnd(i)
            } else
                e()
        }
        ,
    ...
    h.default.fn[Si] = Pi._jQueryInterface,
    h.default.fn[Si].Constructor = Pi,
    h.default.fn[Si].noConflict = function() {
        return h.default.fn[Si] = ki,
        Pi._jQueryInterface
    }
    ,
    e.Alert = d,
...
function(e, t) {
    ...
    function E(e) {
        ...
        e && "object" == typeof e && e.nodeType) {
            ...
            var g = v(t.height);
            return !1 !== g && (i.height = g + (p ? 0 : u + h)),
            i.innerWidth = i.width - (l + f),
            i.innerHeight = i.height - (u + h),
...
function(t, i) {
    "function" == typeof define && define.amd ? define("flickity/js/cell", ["get-size/get-size"], function(e) {
        return i(t, e)
    }) : "object" == typeof module && module.exports ? module.exports = i(t, require("get-size")) : (t.Flickity = t.Flickity || {},
...
function(t, i) {
    "function" == typeof define && define.amd ? define("flickity/js/animate", ["fizzy-ui-utils/utils"], function(e) {
        return i(t, e)
    }) : "object" == typeof module && module.exports ? module.exports = i(t, require("fizzy-ui-utils")) : (t.Flickity = t.Flickity || {},
...
function(s, a) {
    if ("function" == typeof define && define.amd)
        define("flickity/js/flickity", ["ev-emitter/ev-emitter", "get-size/get-size", "fizzy-ui-utils/utils", "./cell", "./slide", "./animate"], function(e, t, i, n, o, r) {
    ...
    function h(e, t) {
        ...
        if (i) {
            ...
            u && u.error("Bad element for Flickity: " + (i || e))
    }
    h.defaults = {
        accessibility: !0,
        cellAlign: "center",
        ...
        this.cells.length) {
            ...
            this.cells.forEach(function(e, t) {
                if (n.cells.length) {
                    ...
                    r.call(this, t, i) || (n.updateTarget(),
                    n = new s(this),
                    this.slides.push(n)),
                    n.addCell(e)
                } else
    ...
    p._wrapSelect = function(e) {
        ...
        !this.isDragSelect && o < n ? e += t : !this.isDragSelect && r < n && (e -= t),
    ...
    p.getParentCell = function(e) {
        var t = this.getCell(e);
        return t || (e = a.getParent(e, ".flickity-slider > *"),
        this.getCell(e))
    }
    ,
    ...
    ,
    a.debounceMethod(h, "onresize", 150),
    p.resize = function() {
        if (this.isActive) {
            this.getSize(),
...
function(t, i) {
    ...
    function l(e, t, i) {
        ...
        setTimeout(this.check.bind(this))) : r.error("Bad element for imagesLoaded " + (n || e))
    }
...
function(e) {
    ...
    function c(e) {
        ...
        return t.each(function() {
            ...
            null === i ? o.push(e) : Math.floor(Math.abs(n - t)) <= 1 ? o[o.length - 1] = i.add(e) : o.push(e),
            n = t
        }),
        o
    }
    ...
    f._apply = function(e, t) {
        ...
        a.css("display", "block"),
        r.byRow && !r.target && (i.each(function() {
            var e = l(this)
              , t = e.css("display");
        ...
        l.each(n, function(e, t) {
            ...
            if (r.target)
                ...
                if (r.byRow && i.length <= 1)
                    return void i.css(r.property, "");
                i.each(function() {
                    var e = l(this)
                      , t = e.attr("style")
                      , i = e.css("display");
        ...
        f._maintainScroll && l(window).scrollTop(o / s * l("html").outerHeight(!0)),
        this
    }
    ,
...
, function(e, t, i) {
    ...
    var a, y, d = v.window.navigator, f = -1 < d.userAgent.indexOf("MSIE ") || -1 < d.userAgent.indexOf("Trident/") || -1 < d.userAgent.indexOf("Edge/"), l = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(d.userAgent), h = function() {
    ...
    function p() {
        y = l ? (!a && document.body && ((a = document.createElement("div")).style.cssText = "position: fixed; top: -9999px; left: 0; height: 100vh; width: 0;",
        document.body.appendChild(a)),
        (a ? a.clientHeight : 0) || v.window.innerHeight || document.documentElement.clientHeight) : v.window.innerHeight || document.documentElement.clientHeight
    }
    p(),
    ...
    function b(e, t) {
        ...
        for (var i, n = e.length, o = 0, r = arguments.length, s = new Array(2 < r ? r - 2 : 0), a = 2; a < r; a++)
            s[a - 2] = arguments[a];
        for (; o < n; o += 1)
            if ("object" === c(t) || void 0 === t ? e[o].jarallax || (e[o].jarallax = new w(e[o],t)) : e[o].jarallax && (i = e[o].jarallax[t].apply(e[o].jarallax, s)),
            void 0 !== i)
                return i;
        return e
    }
    var _ = 0
      , w = function() {
        function l(e, t) {
            ...
            a && "object" === c(a) && void 0 !== a.length && (a = u(a, 1)[0]);
        ...
        return function(e, t, i) {
            ...
            key: "css",
            value: function(t, i) {
                return "string" == typeof i ? v.window.getComputedStyle(t).getPropertyValue(i) : (i.transform && h && (i[h] = i.transform),
                Object.keys(i).forEach(function(e) {
                    t.style[e] = i[e]
                }),
                t)
            ...
            value: function() {
                var e = this
                  ...
                  , s = i
                  , a = 0;
                return o && (n < 0 ? (r = n * Math.max(i, y),
                y < i && (r -= n * (i - y))) : r = n * (i + y),
                1 < n ? s = Math.abs(r - y) : n < 0 ? s = r / n + Math.abs(r) : s += (y - i) * (1 - n),
                r /= 2),
            ...
            value: function(e) {
                ...
                t.isElementInViewport = 0 <= s.bottom && 0 <= s.right && s.top <= y && s.left <= v.window.innerWidth,
                e || t.isElementInViewport) {
                    var a = Math.max(0, n)
                      ...
                      , h = 1 - (y - n) / (y + o) * 2
                      , p = 1;
                    if (o < y ? p = 1 - (u || c) / o : l <= y ? p = l / y : d <= y && (p = d / y),
                    ...
                    "scale" === t.options.type || "scale-opacity" === t.options.type) {
                        var m = 1;
                        t.options.speed < 0 ? m -= t.options.speed * p : m += t.options.speed * (1 - p),
                        r.transform = "scale(".concat(m, ") translate3d(0,0,0)")
                    }
                    if ("scroll" === t.options.type || "scroll-opacity" === t.options.type) {
                        var g = t.parallaxScrollDistance * h;
        ...
        if (void 0 !== e) {
            ...
            ["initImg", "canInitParallax", "init", "destroy", "clipContainer", "coverImage", "isVisible", "onScroll", "onResize"].forEach(function(m) {
                ...
                t.prototype[m] = function() {
                    var e = this;
                    "initImg" === m && null !== e.$item.getAttribute("data-jarallax-element") && (e.options.type = "element",
                    e.pureOptions.speed = e.$item.getAttribute("data-jarallax-element") || e.pureOptions.speed);
                    ...
                    case "init":
                        ...
                        return s && e.$item.setAttribute("style", s),
                        !0;
                    case "onResize":
                        ...
                        break;
                    case "onScroll":
                        var u = e.getWindowData()
                          , c = (u.y + u.height / 2 - e.itemData.y - e.itemData.height / 2) / (u.height / 2)
                          , d = c * e.options.speedY
                          , f = c * e.options.speedX
                          , h = d
                          , p = f;
                        null !== e.options.thresholdY && d > e.options.thresholdY && (h = 0),
                        null !== e.options.thresholdX && f > e.options.thresholdX && (p = 0),
                        e.css(e.$item, {
                            transform: "translate3d(".concat(p, "px,").concat(h, "px,0)")
                        });
                        break;
                    case "initImg":
                    case "isVisible":
    ...
    var a = 0
      ...
      , m = function() {
        ...
        return function(e, t, i) {
            ...
            key: "parseURL",
            value: function(e) {
                var t, i, n, o, r, s = !(!(t = e.match(/.*(?:youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=)([^#\&\?]*).*/)) || 11 !== t[1].length) && t[1], a = !(!(i = e.match(/https?:\/\/(?:www\.|player\.)?vimeo.com\/(?:channels\/(?:\w+\/)?|groups\/([^\/]*)\/videos\/|album\/(\d+)\/video\/|video\/|)(\d+)(?:$|\/|\?)/)) || !i[3]) && i[3], l = (n = e.split(/,(?=mp4\:|webm\:|ogv\:|ogg\:)/),
                o = {},
                r = 0,
                n.forEach(function(e) {
            ...
            key: "fire",
            value: function(e) {
                for (var t = this, i = arguments.length, n = new Array(1 < i ? i - 1 : 0), o = 1; o < i; o++)
                    n[o - 1] = arguments[o];
            ...
            value: function(e) {
                ...
                c.a.YT.PlayerState.PLAYING !== t.player.getPlayerState() && t.player.playVideo()),
            ...
            value: function() {
                var t = this;
                t.player && ("youtube" === t.type && t.player.pauseVideo && c.a.YT.PlayerState.PLAYING === t.player.getPlayerState() && t.player.pauseVideo(),
                ...
                if (i.videoImage)
                    ...
                    if ("youtube" === i.type) {
                        var e = ["maxresdefault", "sddefault", "hqdefault", "0"]
                          ...
                          , o = new Image;
                        o.onload = function() {
                            120 !== (this.naturalWidth || this.width) || n === e.length - 1 ? (i.videoImage = "https://img.youtube.com/vi/".concat(i.videoID, "/").concat(e[n], ".jpg"),
                            t(i.videoImage)) : (n += 1,
                            this.src = "https://img.youtube.com/vi/".concat(i.videoID, "/").concat(e[n], ".jpg"))
                        }
                        ,
                    ...
                    if ("vimeo" === i.type) {
                        ...
                        r.open("GET", "https://vimeo.com/api/v2/video/".concat(i.videoID, ".json"), !0),
                    ...
                    "youtube" === u.type) {
                        ...
                        u.playerOptions.events = {
                            ...
                            onStateChange: function(e) {
                                u.options.loop && e.data === c.a.YT.PlayerState.ENDED && u.play(u.options.startTime),
                                i || e.data !== c.a.YT.PlayerState.PLAYING || (i = 1,
                                u.fire("started", e)),
                                e.data === c.a.YT.PlayerState.PLAYING && u.fire("play", e),
                                e.data === c.a.YT.PlayerState.PAUSED && u.fire("pause", e),
                                e.data === c.a.YT.PlayerState.ENDED && u.fire("ended", e),
                                e.data === c.a.YT.PlayerState.PLAYING ? n = setInterval(function() {
                                    u.fire("timeupdate", e),
                        ...
                        if (o) {
                            ...
                            r.setAttribute("id", u.playerID),
                            e.appendChild(r),
                            document.body.appendChild(e)
                        }
                        u.player = u.player || new c.a.YT.Player(u.playerID,u.playerOptions),
                        o && (u.$video = document.getElementById(u.playerID),
                    ...
                    if ("vimeo" === u.type) {
                        ...
                        !u.$video) {
                            ...
                            Object.keys(u.playerOptions).forEach(function(e) {
                                "" !== s && (s += "&"),
                                s += "".concat(e, "=").concat(encodeURIComponent(u.playerOptions[e]))
                            }),
                            u.$video = document.createElement("iframe"),
                            u.$video.setAttribute("id", u.playerID),
                            u.$video.setAttribute("src", "https://player.vimeo.com/video/".concat(u.videoID, "?").concat(s)),
                        ...
                        var a;
                        u.player = u.player || new c.a.Vimeo.Player(u.$video,u.playerOptions),
            ...
            key: "onAPIready",
            value: function(e) {
                if ("youtube" === this.type && (void 0 !== c.a.YT && 0 !== c.a.YT.loaded || d ? "object" === o(c.a.YT) && 1 === c.a.YT.loaded ? e() : h.done(function() {
                    e()
                }) : (d = 1,
                ...
                "vimeo" === this.type)
                    if (void 0 !== c.a.Vimeo || f)
                        void 0 !== c.a.Vimeo ? e() : p.done(function() {
                            e()
                        });
                    else {
                        f = 1;
                        var t = setInterval(function() {
                            void 0 !== c.a.Vimeo && (clearInterval(t),
                            p.resolve("done"),
                            e())
                        }, 20)
                    }
    ...
    function o() {
        ...
        if (void 0 !== e) {
            ...
            t.prototype.onScroll = function() {
                var i = this;
                n.apply(i),
                i.isVideoInserted || !i.video || i.options.videoLazyLoading && !i.isElementInViewport || i.options.disableVideo() || (i.isVideoInserted = !0,
                i.video.getVideo(function(e) {
                    ...
                    i.$video = e,
                    "local" === i.video.type && (i.image.src ? i.$video.setAttribute("poster", i.image.src) : i.image.$item && "IMG" === i.image.$item.tagName && i.image.$item.src && i.$video.setAttribute("poster", i.image.$item.src)),
            ...
            t.prototype.coverImage = function() {
                ...
                if (t && e.video && i && ("IFRAME" === i || "VIDEO" === i)) {
                    var n = t.image.height
                      ...
                      , s = t.image.marginTop;
                    t.container.width > o && (n = (o = t.container.width) * e.image.height / e.image.width,
                    r = 0,
            ...
            t.prototype.canInitParallax = function() {
                ...
                function n() {
                    i.image.$default_item && (i.image.$item = i.image.$default_item,
                    ...
                    e) {
                        if (t.on("ready", function() {
                            if (i.options.videoPlayOnlyVisible) {
                                ...
                                i.onScroll = function() {
                                    e.apply(i),
                                    i.videoError || !i.options.videoLoop && (i.options.videoLoop || i.videoEnded) || (i.isVisible() ? t.play() : t.pause())
                                }
                            } else
                                t.play()
                        }),
                        t.on("started", function() {
                            ...
                            i.clipContainer(),
                            i.onScroll(),
                            i.image.$default_item && (i.image.$default_item.style.display = "none")
                        }),
                        t.on("ended", function() {
                            i.videoEnded = !0,
                            i.options.videoLoop || n()
                        }),
                        t.on("error", function() {
                            i.videoError = !0,
                            n()
                        ...
                        i.video = t,
                        !i.defaultInitImgResult && (i.image.src = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7",
                        "local" !== t.type))
                            return t.getImageURL(function(e) {
                                i.image.bgImage = 'url("'.concat(e, '")'),
                                i.init()
                            }),
                            !1
                    } else
                        i.defaultInitImgResult || t.getImageURL(function(e) {
                            var t = i.$item.getAttribute("style");
                            t && i.$item.setAttribute("data-jarallax-original-styles", t),
                            i.css(i.$item, {
...
function(e, t) {
    ...
    var u = "undefined" != typeof Element ? Element.prototype : {}
      , c = u.matches || u.matchesSelector || u.webkitMatchesSelector || u.mozMatchesSelector || u.msMatchesSelector || u.oMatchesSelector
      , d = function(e, t) {
        if (!e || 1 !== e.nodeType)
            return !1;
        if (c)
    ...
    function f(e, t) {
        ...
        return function() {
            ...
            n = arguments;
            var e = new Date - s;
            return r || (t <= e ? a() : r = setTimeout(a, t - e)),
            o
        }
        ;
        function a() {
    ...
    function _() {
        ...
        return t.style.cssText = "width:10px;padding:2px;box-sizing:border-box;",
        e.appendChild(t),
    ...
    function x(e, t, i) {
        var n = 2 < arguments.length && void 0 !== i ? i : window.getComputedStyle(e, null)
          , o = p(n[t]);
        return _() || "width" !== t ? _() || "height" !== t || (o += p(n.paddingTop) + p(n.paddingBottom) + p(n.borderTopWidth) + p(n.borderBottomWidth)) : o += p(n.paddingLeft) + p(n.paddingRight) + p(n.borderLeftWidth) + p(n.borderRightWidth),
        o
    }
    var E = {
        reverse: !1,
    ...
    function S(e, t) {
        ...
        return e.length ? o.randomize ? function(e) {
            ...
            var i = o.by(e[o.key])
              , n = o.by(t[o.key]);
            return void 0 === i && void 0 === n ? (r = !0,
            0) : i < n || "sortFirst" === i || "sortLast" === n ? -1 : n < i || "sortLast" === i || "sortFirst" === n ? 1 : 0
        }) : "function" == typeof o.compare && e.sort(o.compare),
        r ? i : (o.reverse && e.reverse(),
        e)) : []
    }
    var T = {}
      , C = "transitionend"
      , k = 0;
    function A(e) {
        return !!T[e] && (T[e].element.removeEventListener(C, T[e].listener),
        !(T[e] = null))
    }
    function I(e, t) {
        function i(e) {
            e.currentTarget === e.target && (A(n),
            t(e))
        }
        var n = C + (k += 1);
        return e.addEventListener(C, i),
        T[n] = {
            element: e,
            listener: i
        },
    ...
    function L(e, t, i, n) {
        var o = e / t;
        return Math.abs(Math.round(o) - o) < n && (o = Math.round(o)),
        Math.min(Math.ceil(o), i)
    }
    function N(e, t, i) {
        if (1 === t)
            return e;
        for (var n = [], o = 0; o <= i - t; o++)
            n.push(D(e.slice(o, o + t)));
        return n
    }
    function P(e, t) {
    ...
    function j(e, c) {
        ...
        return Object.keys(d).forEach(function(e) {
            var t = d[e];
            h.push(t);
            var n, i = t[t.length - 1], o = i.left + i.width, r = Math.round((c - o) / 2), s = t, a = !1;
            if (0 < r) {
                var l = [];
    ...
    var M = 0
      , z = function() {
        function r(e) {
            ...
            s(this, r),
            (t = a(this, o(r).call(this))).options = Object.assign({}, r.options, i),
        ...
        e(r, [{
            ...
            value: function(e, t) {
                ...
                return this._toggleFilterClasses(o),
                "string" == typeof (this.lastFilter = i) && (this.group = i),
                o
            }
        }, {
            ...
            value: function(e, t) {
                var i;
                return 0 === (i = "function" == typeof this.options.columnWidth ? this.options.columnWidth(e) : this.options.sizer ? r.getSize(this.options.sizer).width : this.options.columnWidth ? this.options.columnWidth : 0 < this.items.length ? r.getSize(this.items[0].element, !0).width : e) && (i = e),
                i + t
            }
        }, {
            key: "_getGutterSize",
            ...
            value: function(e) {
                var t = 0 < arguments.length && void 0 !== e ? e : r.getSize(this.element).width
                  ...
                  , o = (t + i) / n;
                Math.abs(Math.round(o) - o) < this.options.columnThreshold && (o = Math.round(o)),
            ...
            value: function(e) {
                return function(e) {
                    for (var t = e.itemSize, i = e.positions, n = e.gridSize, o = e.total, r = e.threshold, s = e.buffer, a = L(t.width, n, o, r), l = N(i, a, o), u = P(l, s), c = new m(n * u,l[u]), d = l[u] + t.height, f = 0; f < a; f++)
                        i[u + f] = d;
                    return c
                }({
                    itemSize: e,
            ...
            key: "filter",
            value: function(e, t) {
                this.isEnabled && ((!e || e && 0 === e.length) && (e = r.ALL_ITEMS),
                this._filter(e),
                this._shrink(),
            ...
            value: function(e, t) {
                var i = 1 < arguments.length && void 0 !== t && t
                  ...
                  , o = x(e, "width", n)
                  , r = x(e, "height", n);
                i && (o += x(e, "marginLeft", n) + x(e, "marginRight", n),
    ...
    z.__sorter = S,
    z.__getColumnSpan = L,
    z.__getAvailablePositions = N,
    z.__getShortColumn = P,
    z.__getCenteredPositions = j,
    z
}),
function(e, t) {
            ...
            function(e, t, i) {
                ...
                value: function() {
                    if (!this._breakpoint) {
                        ...
                        e.containerTop = c.offsetRelative(this.container).top,
                ...
                value: function() {
                    ...
                    var e = this.dimensions
                      ...
                      , i = this.affixedType;
                    return i = t <= e.containerTop || e.containerHeight <= e.sidebarHeight ? (e.translateY = 0,
                ...
                value: function() {
                    ...
                    o = "CONTAINER-BOTTOM") : i >= e.containerTop && (e.translateY = i - e.containerTop,
                    o = "VIEWPORT-TOP") : e.containerBottom <= n ? (e.translateY = e.containerBottom - t,
                    o = "CONTAINER-BOTTOM") : t + e.translateY <= n ? (e.translateY = n - t,
                    o = "VIEWPORT-BOTTOM") : e.containerTop + e.translateY <= i && 0 !== e.translateY && e.maxTranslateY !== e.translateY && (o = "VIEWPORT-UNBOTTOM"),
                    o
                }
            }, {
                ...
                value: function() {
                    ...
                    o = "VIEWPORT-TOP") : e.containerBottom <= n ? (e.translateY = e.containerBottom - t,
                    o = "CONTAINER-BOTTOM") : this.isSidebarFitsViewport() || e.containerTop <= i && 0 !== e.translateY && e.maxTranslateY !== e.translateY && (o = "VIEWPORT-UNBOTTOM"),
                    o
                }
            }, {
                key: "_getStyle",
                ...
                value: function(e) {
                    if (!this._breakpoint) {
                        ...
                        if ((this.affixedType != t || e) && t) {
                            var n = "affix." + t.toLowerCase().replace("viewport-", "") + u;
                            for (var o in c.eventTrigger(this.sidebar, n),
                            "STATIC" === t ? c.removeClass(this.sidebar, this.options.stickyClass) : c.addClass(this.sidebar, this.options.stickyClass),
                            i.outer) {
                ...
                value: function() {
                    ...
                    this.sidebar.removeEventListener("update" + u, this);
                    var e = {
                        inner: {},
                        outer: {}
                    };
                    ...
                    if (n) {
                        n.fn.stickySidebar = function(i) {
                            return this.each(function() {
                                var e = n(this)
                                  , t = n(this).data(o);
                                if (t || (t = new r.default(this,"object" == typeof i && i),
                                e.data(o, t)),
                                "string" == typeof i) {
                                    if (void 0 === t[i] && -1 === ["destroy", "updateSticky"].indexOf(i))
