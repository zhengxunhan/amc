var objectFitImages = function() {
    ...
    function b(e) {
        var t = function(t) {
            for (var e, r = getComputedStyle(t).fontFamily, n = {}; null !== (e = o.exec(r)); )
                n[e[1]] = e[2];
            return n
        }(e)
          , r = e[i];
        ...
        !r.img) {
            if ("fill" === t["object-fit"])
                return;
            if (!r.skipTest && n && !t["object-position"])
                return
        }
        if (!r.img) {
        ...
        e.style.backgroundImage = 'url("' + (r.img.currentSrc || r.img.src).replace(/"/g, '\\"') + '")',
        e.style.backgroundPosition = t["object-position"] || "center",
        e.style.backgroundRepeat = "no-repeat",
        e.style.backgroundOrigin = "content-box",
        /scale-down/.test(t["object-fit"]) ? d(r.img, function() {
    ...
    function m(t, e) {
        ...
        g = !0,
        t = "img"),
        e.watchMQ && window.addEventListener("resize", m.bind(null, t, {
            skipTest: e.skipTest
        }))
    }
    function r(t, e) {
    ...
    return m.supportsObjectFit = n,
    (m.supportsObjectPosition = c) || (HTMLImageElement.prototype.getAttribute = function(t) {
...
Array.from || (Array.from = function() {
    ...
    return function(t, e, r) {
        ...
        for (var c, s = g(n.length), a = l(this) ? Object(new this(s)) : new Array(s), u = 0; u < s; )
            c = n[u],
